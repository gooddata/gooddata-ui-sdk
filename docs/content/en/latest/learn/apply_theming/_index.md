...
When applying theming with GD.UI, you will need to use the **Theme Provider component**, which allows you to customize the visual style of your dashboards by applying a theme (see [Create Custom Themes](https://www.gooddata.ai/docs/cloud/customize-appearance/create-custom-themes/)).
