...
You can read [help page](https://www.gooddata.ai/docs/cloud/manage-organization/jwt-access-token/) that will guide you
...
The guide uses GoodData Python SDK. Alternatively, you can follow [JavaScript guide](https://www.gooddata.ai/docs/cloud/manage-organization/jwt-access-token/jwt-javascript-example/)
