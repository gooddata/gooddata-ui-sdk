...
complex measures using the powerful **Multi-Dimensional Analytical Query Language** ([MAQL](https://www.gooddata.ai/docs/cloud/create-metrics/maql/)). These complex measures work on top
