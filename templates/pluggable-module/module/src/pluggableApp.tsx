...
export const pluggableApp: IPluggableApp = {
    mount({
        ...
        // The host header already shows the product-wide help links. To add app-specific ones,
        // destructure `onHeaderChange` from the mount options and push the WHOLE menu — the push
        // replaces the host default, it does not extend it:
        //   onHeaderChange?.({ helpMenuItems: [...] });
        // See modules/gdc-ldm-modeler/module/src/pluggableApp.tsx for a working example.
