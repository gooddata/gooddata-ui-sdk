...
import { AttributesMapLoaderModule } from '../../src/utils/attributesMapLoader';
    ...
    describe('with fake server', () => {
        ...
        describe('Data Execution:', () => {
            beforeEach(() => {
                serverResponseMock = {
                    executionResult: {
                        ...
                        extendedTabularDataResult: '/gdc/internal/projects/myFakeProjectId/experimental/executions/extendedResults/23452345' // tslint:disable-line:max-line-length
                    }
                };
            });
            ...
            describe('getData', () => {
                it('should resolve with JSON with correct data including headers', () => {
                    ...
                    return createExecution().getData('myFakeProjectId', ['attrId', 'metricId']).then((result) => {
                ...
                it('should reject when execution fails', () => {
                    ...
                    return createExecution().getData('myFakeProjectId', ['attrId', 'metricId']).catch((err) => {
                ...
                it('should wrap response headers with metric mappings', () => {
                    ...
                    return createExecution().getData(
                        'myFakeProjectId',
                ...
                it('should set headers via settings', () => {
                    ...
                    return createExecution()
                        .getData('myFakeProjectId', ['attrId', 'metricId'], {}, { headers: { 'X-GDC-REQUEST': 'foo' } })
                        .then(() => {
            ...
            describe('getData with order', () => {
                it('should propagate orderBy to server call', () => {
                    ...
                    return createExecution().getData('myFakeProjectId', ['attrId', 'metricId'], {
                        orderBy
                    }).then(() => {
        ...
        describe('MD object to execution definitions and columns', () => {
                ...
                return createExecution()
                    ...
                    .then((execConfig: any) => {
                        ...
                        expectMetricDefinition({
                            identifier: 'fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.b9f95d95adbeac03870b764f8b2c3402_filtered_sum', // tslint:disable-line:max-line-length
                            expression: 'SELECT SUM([' + mdEndpoint + '/1144]) ' +
                            'WHERE [' + mdEndpoint + '/949] ' +
                            'IN ([' + mdEndpoint + '/949/elements?id=168284],' +
                            '[' + mdEndpoint + '/949/elements?id=168282])',
                            title: 'Sum of Amount',
                            format: '#,##0.00'
                        }, execConfig);
                        ...
                        expectMetricDefinition({
                            identifier: 'attribute_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1244.generated.a865b88e507b9390e2175b79e1d6252f_count', // tslint:disable-line:max-line-length
                        ...
                        expectMetricDefinition({
                            identifier: 'metric_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_2825.generated.3812d81c1c1609700e47fc800e85bfac_filtered_base', // tslint:disable-line:max-line-length
                            expression: 'SELECT [' + mdEndpoint + '/2825] ' +
                            'WHERE [' + mdEndpoint + '/969] ' +
                            'IN ([' + mdEndpoint + '/969/elements?id=961042],' +
                            '[' + mdEndpoint + '/969/elements?id=961038],' +
                            '[' + mdEndpoint + '/969/elements?id=958079],' +
                            '[' + mdEndpoint + '/969/elements?id=961044],' +
                            '[' + mdEndpoint + '/969/elements?id=961046])',
            ...
            it('handles empty filters', () => {
                ...
                return createExecution()
                    .mdToExecutionDefinitionsAndColumns('qamfsd9cw85e53mcqs74k8a0mwbf5gc2', mdObjWithoutFilters)
                    .then((execConfig: any) => {
                        expectColumns([
                            mdEndpoint + '/1025',
                        ...
                        expectMetricDefinition({
                            identifier: 'fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.7537800b1daf7582198e84ca6205d600_sum', // tslint:disable-line:max-line-length
                            expression: 'SELECT SUM([' + mdEndpoint + '/1144])',
                            title: 'Sum of Amount',
                            format: '#,##0.00'
                        }, execConfig);
                        ...
                        expectMetricDefinition({
                            identifier: 'metric_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_2825.generated.3812d81c1c1609700e47fc800e85bfac_filtered_base', // tslint:disable-line:max-line-length
                            expression: 'SELECT [' + mdEndpoint + '/2825] WHERE [' + mdEndpoint + '/969] IN ([' + mdEndpoint + '/969/elements?id=961042],[' + mdEndpoint + '/969/elements?id=961038],[' + mdEndpoint + '/969/elements?id=958079],[' + mdEndpoint + '/969/elements?id=961044],[' + mdEndpoint + '/969/elements?id=961046])', // tslint:disable-line:max-line-length
                            title: '# of Opportunities (Account: 1 Source Consulting, 1-800 Postcards, 1-800 We Answer, 1-888-OhioComp, 14 West)', // tslint:disable-line:max-line-length
                            format: '#,##0'
                        }, execConfig);
                    });
        ...
        describe('generating contribution metric', () => {
            ...
            it('for calculated measure', () => {
                return createExecution()
                    ...
                    .then((execConfig: any) => {
                        ...
                        expectMetricDefinition({
                            title: '% # of Opportunities',
                            identifier: 'metric_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_2825.generated.0eb685df0742b4e27091746615e06193_percent', // tslint:disable-line:max-line-length
                            expression: 'SELECT (SELECT [' + mdEndpoint + '/2825]) / (SELECT [' + mdEndpoint + '/2825] BY ALL [' + mdEndpoint + '/1027])', // tslint:disable-line:max-line-length
                            format: '#,##0.00%'
                        }, execConfig);
                    });
            });
            ...
            it('for generated measure', () => {
                ...
                return createExecution()
                    .mdToExecutionDefinitionsAndColumns('qamfsd9cw85e53mcqs74k8a0mwbf5gc2', mdObjContributionCloned)
                    .then((execConfig: any) => {
                        expectColumns([
                            mdEndpoint + '/1027',
                        ...
                        expectMetricDefinition({
                            title: '% Sum of Amount',
                            identifier: 'fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.3124707f49557fe26b7eecfa3f61b021_percent', // tslint:disable-line:max-line-length
                            expression: 'SELECT (SELECT SUM([' + mdEndpoint + '/1144])) / (SELECT SUM([' + mdEndpoint + '/1144]) BY ALL [' + mdEndpoint + '/1027])', // tslint:disable-line:max-line-length
                            format: '#,##0.00%'
                        }, execConfig);
                    });
            });
            ...
            it('for generated measure with attribute filters', () => {
                                        ...
                                        filters: [
                                            {
                                                positiveAttributeFilter: {
                                                    ...
                                                    in: [
                                                        mdEndpoint + '/42/elements?id=61527'
                                                    ]
                                                }
                                            }
                                        ]
                ...
                return createExecution()
                    ...
                    .then((execConfig: any) => {
                        ...
                        expectMetricDefinition({
                            title: '% Sum of Amount',
                            identifier: 'fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1.generated.08fe4920a4353ed70cdb0cb255489611_filtered_percent', // tslint:disable-line:max-line-length
                            expression: 'SELECT (' +
                                'SELECT SUM([' + mdEndpoint + '/1]) ' +
                                'WHERE [' + mdEndpoint + '/42] ' +
                                'IN ([' + mdEndpoint + '/42/elements?id=61527])' +
                            ') / (' +
                                'SELECT SUM([' + mdEndpoint + '/1]) ' +
                                'BY ALL [' + mdEndpoint + '/1027] ' +
                                'WHERE [' + mdEndpoint + '/42] ' +
                                'IN ([' + mdEndpoint + '/42/elements?id=61527])' +
                            ')',
                            format: '#,##0.00%'
            ...
            it('for calculated metric', () => {
                return createExecution()
                    ...
                    .then((execConfig: any) => {
                        ...
                        expectMetricDefinition({
                            title: '# of Opportunities - previous year',
                            identifier: 'metric_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_2825.generated.0e380388838e2d867a3d11ea64e22573_pop', // tslint:disable-line:max-line-length
                            expression: 'SELECT [' + mdEndpoint + '/2825] FOR PREVIOUS ([' + mdEndpoint + '/1233])',
                            format: '#,##0'
                        }, execConfig);
                    });
            });
            ...
            it('for generated measure', () => {
                ...
                return createExecution()
                    ...
                    .then((execConfig: any) => {
                        ...
                        expectMetricDefinition({
                            identifier: 'fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.00d7d51e0e86780bebfe65b025ed8f14_pop', // tslint:disable-line:max-line-length
                            expression: 'SELECT (SELECT SUM([' + mdEndpoint + '/1144])) FOR PREVIOUS ([' + mdEndpoint + '/1233])', // tslint:disable-line:max-line-length
                            title: 'Sum of Amount - previous year',
                            format: '#,##0.00'
                        }, execConfig);
            ...
            it('for generated measure with contribution', () => {
                ...
                return createExecution()
                    ...
                    .then((execConfig: any) => {
                        ...
                        expectMetricDefinition({
                            title: '% Sum of Amount - previous year',
                            identifier: 'fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.985ea06c284684b6feb0b05a6d796034_pop', // tslint:disable-line:max-line-length
                            expression: 'SELECT (SELECT (SELECT SUM([' + mdEndpoint + '/1144])) / (SELECT SUM([' + mdEndpoint + '/1144]) BY ALL [' + mdEndpoint + '/1233])) FOR PREVIOUS ([' + mdEndpoint + '/1233])', // tslint:disable-line:max-line-length
                            format: '#,##0.00%'
                        }, execConfig);

                        expectMetricDefinition({
                            title: '% Sum of Amount',
                            identifier: 'fact_qamfsd9cw85e53mcqs74k8a0mwbf5gc2_1144.generated.93434aa1d9e8d4fe653757ba8c891025_percent', // tslint:disable-line:max-line-length
                            expression: 'SELECT (SELECT SUM([' + mdEndpoint + '/1144])) / (SELECT SUM([' + mdEndpoint + '/1144]) BY ALL [' + mdEndpoint + '/1233])', // tslint:disable-line:max-line-length
                            format: '#,##0.00%'
                        }, execConfig);
                    });
            });
