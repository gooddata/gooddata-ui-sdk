    ...
    describe('with fake server', () => {
        ...
        describe('getObjectsByQuery', () => {
            it('should reject with 400 from backend and not use default limit', () => {
                ...
                return createMd().getObjectsByQuery('myFakeProjectId', { limit: 5 })
            ...
            it('should return correct number of entries on two pages', () => {
                ...
                fetchMock.mock(
                    '/gdc/md/myFakeProjectId/objects/query?category=dataSet&limit=50',
                ...
                fetchMock.mock(
                    '/gdc/md/myFakeProjectId/objects/query?category=dataSet&limit=50&offset=50',
                    { status: 200, body: body2 }
                );

                return createMd().getObjectsByQuery('myFakeProjectId', { category: 'dataSet' }).then((result: any) => {
        ...
        describe('getVisualizations', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getVisualizations('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
            ...
            it('should return correct number of entries', () => {
                ...
                return createMd().getVisualizations('myFakeProjectId').then((result: any) => {
        ...
        describe('getAttributes', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getAttributes('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
            ...
            it('should return correct number of entries', () => {
                ...
                return createMd().getAttributes('myFakeProjectId').then((result: any) => {
                    expect(result.length).toBe(2);
                });
            });
        });
        ...
        describe('createObject', () => {
            it('should return created object', () => {
                ...
                return createMd().createObject('myFakeProjectId', newObj).then((createdObj: any) => {
        ...
        describe('etlPull', () => {
            ...
            describe('/gdc/md/1/etl/pull2 call successful', () => {
                ...
                it('should poll until task status is OK', () => {
                    ...
                    return createMd().etlPull('1', '1', { pollStep: 1 }).then((result: any) => {
            ...
            describe('/gdc/md/1/etl/pull2 call not successful', () => {
                it('should reject if task ends with error', () => {
                    ...
                    return createMd().etlPull('1', '1').then(() => {
        ...
        describe('ldmManage', () => {
            ...
            describe('/gdc/md/1/ldm/manage2 call successful', () => {
                ...
                it('should poll until task status is OK', () => {
                    ...
                    return createMd().ldmManage('1', '1', { pollStep: 1 }).then((result: any) => {
                        expect(result).toEqual(finishedTask);
                    });
                });
            });
            ...
            describe('/gdc/md/1/ldm/manage2 call not successful', () => {
                it('should reject if task ends with error', () => {
                    ...
                    return createMd().ldmManage('1', '1').then(() => {
                        throw new Error('Should reject the promise if task ends with error');
                    }, (err: any) => {
                        expect(err).toBeInstanceOf(Error);
                    });
        ...
        describe('getDimensions', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getDimensions('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
            ...
            it('should return correct number of entries', () => {
                ...
                return createMd().getDimensions('myFakeProjectId').then((result: any) => {
                    expect(result.length).toBe(2);
                });
            });
        });
        ...
        describe('getFacts', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getFacts('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
            ...
            it('should return correct number of entries', () => {
                ...
                return createMd().getFacts('myFakeProjectId').then((result: any) => {
                    expect(result.length).toBe(2);
                });
            });
        });
        ...
        describe('getMetrics', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getMetrics('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
            ...
            it('should return correct number of entries', () => {
                ...
                return createMd().getMetrics('myFakeProjectId').then((result: any) => {
                    expect(result.length).toBe(2);
                });
            });
        });
        ...
        describe('getAvailableMetrics', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getAvailableMetrics('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
            ...
            it('should return correct number of entries', () => {
                ...
                return createMd().getAvailableMetrics('myFakeProjectId').then((result: any) => {
                    expect(result.length).toBe(2);
                });
            });
        });
        ...
        describe('getAvailableAttributes', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getAvailableAttributes('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
        ...
        describe('getAvailableFacts', () => {
            it('should reject with 400 from backend', () => {
                ...
                return createMd().getAvailableFacts('myFakeProjectId')
                    .then(okCallback, errorCallback)
                    .then(() => {
                        expect(okCallback).not.toHaveBeenCalled();
                        expect(errorCallback).toHaveBeenCalled();
        ...
        describe('getUrisFromIdentifiers', () => {
            it('should return array with identifiers and uris', () => {
                ...
                return createMd().getUrisFromIdentifiers('myFakeProjectId', ['attr.foo.bar'])
                    .then((result: any) => {
        ...
        describe('translateElementLabelsToUris', () => {
            it('should return two label uris', () => {
                ...
                return createMd()
                    .translateElementLabelsToUris('myFakeProjectId', '/gdc/md/labelUri', ['2014-01-01', '2016-01-01'])
                    .then((result: any) => {
        ...
        describe('getObjectUri', () => {
            it('should return uri when identifier exists', () => {
                ...
                return createMd().getObjectUri('myFakeProjectId', 'attr.foo.bar').then((result: any) => {
            ...
            it('should reject promise when identifier does not exist', () => {
                ...
                return createMd().getObjectUri('myFakeProjectId', 'foo.bar').catch((err: any) => {
                    expect(err).toBeInstanceOf(Error);
                });
            });
        });
        ...
        describe('getObjectUsing', () => {
            ...
            it('should load object dependencies', () => {
                ...
                return createMd().getObjectUsing(projectId, object, { types }).then((result: any) => {
            ...
            it('should be properly called with nearest when requested', () => {
                ...
                return createMd().getObjectUsing(projectId, object, { types, nearest }).then(() => {
                    const request = fetchMock.lastOptions(using2Uri) as RequestInit;
            ...
            it('should return rejected promise if 400 returned from backend', () => {
                ...
                return createMd().getObjectUsing(projectId, object, { types }).then(() => {
        ...
        describe('getObjectUsingMany', () => {
            ...
            it('should load objects dependencies', () => {
                ...
                return createMd().getObjectUsingMany(projectId, objects, { types }).then((result: any) => {
                    const request = fetchMock.lastOptions(using2Uri) as RequestInit;
            ...
            it('should be properly called with nearest when requested', () => {
                ...
                return createMd().getObjectUsingMany(projectId, objects, { types, nearest }).then(() => {
                    const request = fetchMock.lastOptions(using2Uri) as RequestInit;
        ...
        describe('getObjects', () => {
            ...
            it('should load elements', () => {
                ...
                return createMd().getObjects(projectId, uris).then((result: any) => {
            ...
            it('should translate properties using references', () => {
                ...
                const serverResponses = [
                    { visualizationObject: {
                         content: { properties: '{"foo":"id_0"}', references: { id_0: '/gdc/md/123/obj/45678' } } }
                    }
                ];
                ...
                fetchMock.mock(
                    getUri,
                    { status: 200, body: JSON.stringify({ objects: { items: serverResponses } }) }
                );
            ...
            it('should return rejected promise if 400 returned from backend', () => {
                ...
                return createMd().getObjects(projectId, uris).then(() => {
                    throw new Error('Should reject the promise on 400 response');
                }).catch((err: any) => {
                    expect(err.response.status).toBe(400);
                });
        ...
        describe('getValidElements', () => {
            ...
            it('should process params from options', () => {
                ...
                return createMd().getValidElements(projectId, attributeId, options)
                    .then((result: any) => {
        ...
        describe('getVisualization', () => {
            it('should return visualization with properties translated', () => {
                ...
                fetchMock.mock(
                    uri,
                    { status: 200, body: JSON.stringify(serverResponse) }
                );

                return createMd().getVisualization(uri).then((result) => {
        ...
        describe('saveVisualization', () => {
            it('should send visualization with properties translated', () => {
                ...
                fetchMock.mock(
                    '/gdc/md//gdc/md/123/obj/456/obj?createAndGet=true',
                    { status: 200 }
                );

                return createMd().saveVisualization(uri, inputObject).then(() => {
