...
import { ExecutionModule } from '../src/execution';
...
describe('Catalogue', () => {
    ...
    describe('#loadItems', () => {
        ...
        it('should load items from loadCatalog server end point', () => {
            return createCatalogue().loadItems(projectId, fixtures.optionsForEmptySelection).then(() => {
        ...
        it('should send maql for fact base measures', () => {
            ...
            return createCatalogue().loadItems(projectId, options).then(() => {
        ...
        it('should not override bucketItems prop', () => {
            ...
            return createCatalogue().loadItems(projectId, { bucketItems: [dummyUri] }).then(() => {
        ...
        it('should correctly resolve items with nested maql expressions', () => {
            ...
            return createCatalogue().loadItems(projectId, options).then(() => {
                expect(getRequestBody()).toEqual(fixtures.requestForMeasureWithFilterAndCategoryShowInPercent);
            });
        });
        ...
        it('should correctly resolve items with nested maql expressions and negative filter element selection', () => {
            ...
            return createCatalogue().loadItems(projectId, options).then(() => {
                expect(getRequestBody()).toEqual(fixtures.requestForMeasureWithNotInFilterAndCategoryShowInPercent);
            });
        });
    ...
    describe('#loadDateDataSets', () => {
        ...
        it('should generate basic request structure', () => {
            return createCatalogue().loadDateDataSets(projectId, {}).then(() => {
        ...
        it('should send convert dataSetIdentifier to customIdentifiers', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, { dataSetIdentifier }).then(() => {
        ...
        it('should send type ALL when sending returnAllDateDataSets', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, { returnAllDateDataSets }).then(() => {
                const { requiredDataSets } = getRequestBody().dateDataSetsRequest;
                expect(requiredDataSets).toEqual({
                    type: 'ALL'
                });
        ...
        it('should omit requiredDataSets parameter when sending returnAllRelatedDateDataSets', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, { returnAllRelatedDateDataSets }).then(() => {
                const { requiredDataSets } = getRequestBody().dateDataSetsRequest;
        ...
        it('should send empty columns if only date buckets are in the request', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, mockPayload).then(() => {
        ...
        it('should replace identifiers with pure MAQL', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, mockPayload).then(() => {
                ...
                expect(bucketItems).toEqual([
                    ...
                    'SELECT (SELECT (SELECT SUM([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2276]) WHERE [/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266] NOT IN ([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266/elements?id=706])) / (SELECT SUM([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2276]) BY ALL [/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2274] WHERE [/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266] NOT IN ([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266/elements?id=706]))) FOR PREVIOUS ([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2167])', // tslint:disable-line:max-line-length
                    'SELECT (SELECT SUM([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2276]) WHERE [/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266] NOT IN ([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266/elements?id=706])) / (SELECT SUM([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2276]) BY ALL [/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2274] WHERE [/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266] NOT IN ([/gdc/md/ovs4ke6eyaus033gyojhv1rh7u1bukmy/obj/2266/elements?id=706]))' // tslint:disable-line:max-line-length
                ]);
            });
        });
        ...
        it('should use option includeObjectsWithTags if provided', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, { includeObjectsWithTags }).then(() => {
                expect(getRequestBody().dateDataSetsRequest.includeObjectsWithTags).toEqual(['a', 'b', 'c']);
            });
        });
        ...
        it('should use option excludeObjectsWithTags if provided', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, { excludeObjectsWithTags }).then(() => {
                expect(getRequestBody().dateDataSetsRequest.excludeObjectsWithTags).toEqual(['a', 'b', 'c']);
            });
        });
        ...
        it('should use option includeObjectsWithTags and omit excludeObjectsWithTags if both provided', () => {
            ...
            return createCatalogue().loadDateDataSets(projectId, options).then(() => {
