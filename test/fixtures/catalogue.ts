                ...
                availableDateAttributes: [
                    ...
                    },
                    {
                        attributeMeta: {
                            ...
                            summary: 'Week/Year based on EU Weeks (Mon-Sun). By default, if a week spans multiple years or quarters (ie, end of the year/quarter), it is marked as first or last week of the period according to particular standards (ie, US or EU). Labels marked as \'Continuous\' show both weeks (W53/2009 - W1/2010).', // tslint:disable-line:max-line-length
                            isProduction: 0,
                            unlisted: 0,
                            category: 'attribute',
                            updated: '2016-06-01 11:08:55',
