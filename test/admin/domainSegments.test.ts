...
import { DomainSegmentsModule } from '../../src/admin/domainSegments';
                    ...
                    '/gdc/admin/contracts/contractId/dataproducts/dataproductId/segments/segmentId/domainsegments/data-admin-test1', // tslint:disable-line:max-line-length
                    {
                        ...
                        body: JSON.stringify({
                            domainSegment: {
                                ...
                                links: {
                                    self: '/gdc/admin/contracts/contractId/dataproducts/dataproductId/segments/segmentId/domainsegments/data-admin-test1' // tslint:disable-line:max-line-length
                                }
                            }
                        })
                    }
                            ...
                            domainSegments: {
                                items: [{
                                    ...
                                    domainSegment: {
                                        ...
                                        links: {
                                            self: '/gdc/admin/contracts/contractId/dataproducts/dataproductId/segments/segmentId1/domainsegments/data-admin-test2' // tslint:disable-line:max-line-length
                                        }
                                    }
                                }]
                            }
