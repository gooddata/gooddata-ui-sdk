    ...
    describe('with fake server', () => {
        describe('getDataProductSegments', () => {
                            ...
                            segments: {
                                items: [{
                                    segment: {
                                        ...
                                        links: {
                                            self: '/gdc/admin/contracts/contractId/dataproducts/dataproductId/segments/segmentId' // tslint:disable-line:max-line-length
                                        }
                                    }
                                }, {
                                    segment: {
                                        ...
                                        links: {
                                            self: '/gdc/admin/contracts/contractId/dataproducts/dataproductId/segments/segmentId1' // tslint:disable-line:max-line-length
                                        }
                                    }
                                }]
                            }
            ...
            it('should create dataproduct', () => {
                ...
                return createSegmentsModule()
                    .createSegment('contractId', 'dataproductId', 'segmentId', ['data-admin-test1', 'data-admin-test2'])
                    .then((result: any) => {
