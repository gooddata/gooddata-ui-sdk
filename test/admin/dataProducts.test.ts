...
import { DataProductsModule } from '../../src/admin/dataProducts';
    ...
    describe('with fake server', () => {
        describe('getDataProduct', () => {
                        ...
                        body: JSON.stringify({
                            dataProduct: {
                                ...
                                links: {
                                    ...
                                    domainDataProducts: ['/gdc/admin/contracts/contractId/domains/data-admin-test1/dataproducts/dataproductId'], // tslint:disable-line:max-line-length
                                    domainSegments: ['/gdc/admin/contracts/contractId/domains/data-admin-test1/dataproducts/dataproductId/segments'], // tslint:disable-line:max-line-length
            ...
            it('should return dataproducts', () => {
                                ...
                                items: [{
                                    dataProduct: {
                                        ...
                                        links: {
                                            ...
                                            domainDataProducts: ['/gdc/admin/contracts/contractId/domains/data-admin-test1/dataproducts/dataproductId'], // tslint:disable-line:max-line-length
                                            domainSegments: ['/gdc/admin/contracts/contractId/domains/data-admin-test1/dataproducts/dataproductId/segments'], // tslint:disable-line:max-line-length
                                            segments: ['/gdc/admin/contracts/contractId/dataproducts/dataproductid/segments'], // tslint:disable-line:max-line-length
                                    ...
                                    dataProduct: {
                                        ...
                                        links: {
                                            ...
                                            domainDataProducts: ['/gdc/admin/contracts/contractId/domains/data-admin-test1/dataproducts/dataproductId1'], // tslint:disable-line:max-line-length
                                            domainSegments: ['/gdc/admin/contracts/contractId/domains/data-admin-test2/dataproducts/dataproductId1/segments'], // tslint:disable-line:max-line-length
                                            segments: ['/gdc/admin/contracts/contractId/dataproducts/dataproductId1/segments'], // tslint:disable-line:max-line-length
                ...
                return createDataProductsModule().getDataProducts('contractId', '').then((result: any) => {
            ...
            it('should create dataproduct', () => {
                ...
                return createDataProductsModule()
                    .createDataProduct('contractId', 'dataproductId', ['data-admin-test1', 'data-admin-test2'])
                    .then((r: ApiResponse) => r.response).then((result: any) => {
