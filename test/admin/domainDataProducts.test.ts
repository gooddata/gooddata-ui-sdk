...
import { DomainDataProductModule } from '../../src/admin/domainDataProducts';
    ...
    describe('with fake server', () => {
        describe('getDomainDataProducts', () => {
            ...
            it('should return domaindataproducts', () => {
                                ...
                                items: [{
                                    domainDataProduct: {
                                        ...
                                        links: {
                                            ...
                                            domainSegments: ['/gdc/admin/contracts/contractId/dataproducts/dataproductId/segments'], // tslint:disable-line:max-line-length
                                            self: 'gdc/admin/contracts/contractId/dataproducts/dataproductId/domaindataproducts/data-admin-test1' // tslint:disable-line:max-line-length
                                        }
                                    }
                                }]
                            }
                ...
                return createDomainDataproductsModule()
                    .getDomainDataProducts('contractId', 'dataProductId').then((result: any) => {
