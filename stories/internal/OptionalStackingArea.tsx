...
import { areaChartWith3MetricsAndViewByAttribute, areaChartWithMeasureViewByAndStackBy } from '../test_data/fixtures';
...
storiesOf('Internal/OptionalStacking/Area Chart', module)
    ...
    .add('Chart with viewBy 2 attributes and \'Stack Measures\' enabled', () => {
        return screenshotWrap(renderSupportedCharts(
