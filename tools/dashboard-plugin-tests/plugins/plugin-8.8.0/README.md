...
2.  Develop your plugin code in `src/dp_plugin_8_8_0`

    The `src/dp_plugin_8_8_0/Plugin.tsx` is the main plugin file where you have to register all
    your custom content. However, you can create as many new files as you want under the `src/dp_plugin_8_8_0`
...
5.  Add plugin to one or more workspaces: `npm run add-plugin -- <url>`
    ...
    Run the `npm run add-plugin -- "https://your.hosting/pluginDirOfYourChoice/dp_plugin_8_8_0.js"` to
...
6.  Use plugin on a dashboard: `npm run link-plugin -- <plugin-object-id>`
    ...
    If your plugin supports parameterization (see [src/dp_plugin_8_8_0](./src/dp_plugin_8_8_0/Plugin.tsx)) and
...
This project is setup so that all your custom code must be self-contained in the [src/dp_plugin_8_8_0](./src/dp_plugin_8_8_0) directory.

The [src/dp_plugin_8_8_0_engine](./src/dp_plugin_8_8_0_engine) and [src/dp_plugin_8_8_0_entry](./src/dp_plugin_8_8_0_entry) directories contain essential plugin boilerplate.
...
You can modify minEngineVersion and maxEngineVersion properties in `src/dp_plugin_8_8_0\_entry/index`.
