...
describe('ArithmeticMeasureTitleFactory', () => {
    describe('getTitle', () => {
        ...
        it('should return null when the first master measure does not have title', () => {
            ...
            const title = titleFactory.getTitle(arithmeticMeasureProps, [firstMeasureWithoutTitle, MEASURE_TITLE_2]);
        ...
        it('should return null when the second master measure does not have title', () => {
            ...
            const title = titleFactory.getTitle(arithmeticMeasureProps, [MEASURE_TITLE_1, secondMeasureWithoutTitle]);
        ...
        it('should return correct title for sum arithmetic measure with renamed master measure titles', () => {
            ...
            const title = titleFactory.getTitle(arithmeticMeasureProps, [renamedMeasureTitle1, renamedMeasureTitle2]);
        ...
        it('should return correct title for sum arithmetic measure with three master measures', () => {
            ...
            const title = titleFactory.getTitle(
                arithmeticMeasureProps,
                [MEASURE_TITLE_1, MEASURE_TITLE_2, MEASURE_TITLE_3]
            );
