export const deDE = {
    'visualizations.more': 'Mehr anzeigen',
    'visualizations.less': 'Weniger anzeigen',
    'visualizations.sorting': 'Spaltensortierung',
    'visualizations.asc': 'Aufsteigend',
    'visualizations.desc': 'Absteigend',
