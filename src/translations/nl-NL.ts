export const nlNL = {
    'visualizations.more': 'Meer weergeven',
    'visualizations.less': 'Minder weergeven',
    'visualizations.sorting': 'Kolomsortering',
    'visualizations.asc': 'Oplopend',
    'visualizations.desc': 'Aflopend',
