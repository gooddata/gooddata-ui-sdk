...
const VIS_OBJ_TESTS = [
    ...
    [ 'absolute date filter with identifier', input.absoluteDateFilterWithIdentifier, expected.absoluteDateFilterWithIdentifier ],
    ...
    [ 'relative date filter with identifier', input.relativeDateFilterWithIdentifier, expected.relativeDateFilterWithIdentifier ],
