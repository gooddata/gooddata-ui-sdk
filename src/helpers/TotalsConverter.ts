...
export function convertToIndexedTotals(totals: VisualizationObject.IVisualizationTotal[],
                                       afm: AFM.IAfm, resultSpec: AFM.IResultSpec):
    IIndexedTotalItem[] {
...
export function convertToTotals(indexedTotals: IIndexedTotalItem[], afm: AFM.IAfm):
