...
export const twoAttributesTwoMeasuresUnEvenGroups = {
    rowData: [{
        headerItemMap: {
            ...
            a_5DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/5/elements?id=1', name: 'low' } }
        },
        a_4DOTdf: 'Pink',
        a_5DOTdf: 'low',
        m_0: '678',
        ...
        headerItemMap: {
            ...
            a_5DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/5/elements?id=2', name: 'medium' } }
        },
        a_4DOTdf: 'Red',
        a_5DOTdf: 'medium',
        m_0: '47',
        ...
        headerItemMap: {
            ...
            a_5DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/5/elements?id=3', name: 'high' } }
        },
        a_4DOTdf: 'Red',
        a_5DOTdf: 'high',
        m_0: '864',
...
export const twoAttributesTwoMeasuresEvenGroupsFristPage = {
    rowData: [{
        ...
        headerItemMap: {
            a_4DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/4/elements?id=1', name: 'Pink' } },
            a_5DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/5/elements?id=2', name: 'medium' } }
        },
        a_4DOTdf: 'Pink',
        a_5DOTdf: 'medium',
        ...
        headerItemMap: {
            a_4DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/4/elements?id=2', name: 'Red' } },
            a_5DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/5/elements?id=1', name: 'low' } }
        },
        a_4DOTdf: 'Red',
        a_5DOTdf: 'low',
...
export const twoAttributesTwoMeasuresEvenGroupsSecondPage = {
    rowData: [{
        ...
        headerItemMap: {
            a_4DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/4/elements?id=3', name: 'Purple' } },
            a_5DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/5/elements?id=1', name: 'low' } }
        },
        a_4DOTdf: 'Purple',
        a_5DOTdf: 'low',
        ...
        headerItemMap: {
            a_4DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/4/elements?id=4', name: 'Salmon' } },
            a_5DOTdf: { attributeHeaderItem: { uri: '/gdc/md/storybook/obj/5/elements?id=1', name: 'low' } }
        },
        a_4DOTdf: 'Salmon',
        a_5DOTdf: 'low',
