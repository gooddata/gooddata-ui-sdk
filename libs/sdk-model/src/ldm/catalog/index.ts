...
export { CatalogAttributeBuilder, newCatalogAttribute } from "./attribute/factory";

export { ICatalogMeasure, isCatalogMeasure } from "./measure";
export { CatalogMeasureBuilder, newCatalogMeasure } from "./measure/factory";
