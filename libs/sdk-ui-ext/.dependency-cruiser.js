options = {
    forbidden: [
        ...
        {
            name: "internal-dependents-through-index",
            comment: "Other components depending on internal must do so through its index.ts.",
            severity: "error",
            from: {
                pathNot: "^(src/internal)",
            },
            to: {
                path: "src/internal/(assets|components|constants|interfaces|tests|translations|utils)",
            },
        },
        {
    ...
    options: {
        ...
        */
        doNotFollow: {
            path: ".*(node_modules|gd-bear|sdk-model|sdk-backend|sdk-ui|__mocks__|test|tests).*",
