...
export function Notification({
    ...
    const actions = compact([
        ...
        hasFile && fileExpiresAt && <FileExpiration fileExpiresAt={fileExpiresAt} />,
    ]);

    return (
        <BubbleHoverTrigger enabled={hasFile}>
            <div
            ...
            >
                ...
                <div className={e("details")}>
                    <div className={e("title", { isRead: notification.isRead })} title={notificationTitle}>
                        {isScheduleNotification ? "Download" : null} {notificationTitle}
                    </div>
                    {isError ? (
...
const FileExpiration = ({ fileExpiresAt }: { fileExpiresAt: string }) => {
    return (
        <BubbleHoverTrigger eventsOnBubble={true}>
            <span>
                <FormattedMessage
