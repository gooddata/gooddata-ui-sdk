...
describe("PluggableHeadline2", () => {
    ...
    describe("getExtendedReferencePoint", () => {
        ...
        describe("known buckets", () => {
            ...
            it("should keep primary bucket empty when primary measures bucket is empty and secondary source bucket contains 2 measures", async () => {
                const referencePoint = createReferencePointWithDateFilter([
                    {
                        localIdentifier: "measures",
                        items: [],
            ...
            it("should place measures to primary and secondary buckets when secondary source bucket contains 3 measures", async () => {
                const referencePoint = createReferencePointWithDateFilter([
                    {
                        localIdentifier: "measures",
                        items: [],
        ...
        describe("unknown buckets", () => {
            ...
            it("should keep primary bucket empty and secondary buckets when second source bucket contains 2 measures", async () => {
                const referencePoint = createReferencePointWithDateFilter([
                    {
                        localIdentifier: "unknown_measures",
                        items: [],
        ...
        describe("Arithmetic measures", () => {
            ...
            it("should kip AM that does not fit and place derived together with master", async () => {
                const headline = createComponent();
