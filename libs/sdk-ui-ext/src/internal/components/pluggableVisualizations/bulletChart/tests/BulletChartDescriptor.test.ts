...
import { BulletChartDescriptor } from "../BulletChartDescriptor";

describe("BulletChartDescriptor", () => {
    it("should generate embedding code without context", () => {
        // TODO replace by some recording?
        const insight = newInsightDefinition("local:bullet", (i) =>
            i.buckets([
                newBucket(
        ...
        const descriptor = new BulletChartDescriptor();
