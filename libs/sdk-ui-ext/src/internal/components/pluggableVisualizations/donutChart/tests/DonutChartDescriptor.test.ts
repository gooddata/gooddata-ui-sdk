...
import { DonutChartDescriptor } from "../DonutChartDescriptor";

describe("DonutChartDescriptor", () => {
    it("should generate embedding code without context", () => {
        // TODO replace by some recording?
        const insight = newInsightDefinition("local:donut", (i) =>
            i.buckets([
                newBucket(
        ...
        const descriptor = new DonutChartDescriptor();
