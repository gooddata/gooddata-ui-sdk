...
import { type IRadarChartProps } from "@gooddata/sdk-ui-charts";
...
export class RadarChartDescriptor extends BaseChartDescriptor implements IVisualizationDescriptor {
    public getFactory(): PluggableVisualizationFactory {
        return (params) => new PluggableRadarChart(params);
    }
    ...
    public getEmbeddingCode = getReactEmbeddingCodeGenerator({
        ...
        insightToProps: getInsightToPropsConverter<IRadarChartProps>({
    ...
    public getMeta(): IVisualizationMeta {
        return {
            documentationUrl:
                "https://www.gooddata.com/docs/gooddata-ui/latest/references/visual_components/radar_chart",
            supportsExport: true,
