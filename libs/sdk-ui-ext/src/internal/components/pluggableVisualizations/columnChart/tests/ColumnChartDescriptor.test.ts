...
import { ColumnChartDescriptor } from "../ColumnChartDescriptor";

describe("ColumnChartDescriptor", () => {
    it("should generate embedding code without context", () => {
        // TODO replace by some recording?
        const insight = newInsightDefinition("local:column", (i) =>
            i
                .buckets([
                    newBucket(
        ...
        const descriptor = new ColumnChartDescriptor();
