...
/**
 * Aggregate of every runtime export of this file. Every newly added config MUST be listed here,
 * otherwise the test in `uiConfig.test.ts` (which enumerates this object instead of the module
 * namespace) stops catching it.
 */
export const uiConfigs = {
    ...
    disabledOpenAsReportConfig,
    defaultRootUiConfigProperties,
    DEFAULT_SCATTERPLOT_UICONFIG,
    DEFAULT_MEKKO_UICONFIG,
    ...
    DEFAULT_TABLE_UICONFIG,
    DEFAULT_HEADLINE_UICONFIG,
    DEFAULT_HEATMAP_UICONFIG,
    COMBO_CHART_UICONFIG_DEPRECATED,
    COMBO_CHART_UICONFIG,
    DEFAULT_XIRR_UICONFIG,
    DEFAULT_BULLET_CHART_CONFIG,
    BULLET_CHART_CONFIG_MULTIPLE_DATES,
    GEO_PUSHPIN_CHART_UICONFIG,
    GEO_AREA_CHART_UICONFIG,
    DEFAULT_SANKEY_UI_CONFIG,
    DEFAULT_REPEATER_UI_CONFIG,
    getTreemapUiConfig,
};
