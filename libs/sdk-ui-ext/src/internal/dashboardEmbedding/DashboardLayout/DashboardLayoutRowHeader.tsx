...
export const DashboardLayoutRowHeader: React.FC<IDashboardLayoutRowHeaderProps> = (props) => {
            ...
            <div className="gd-fluid-layout-row-header-container">
                {renderHeader ?? (
                    <div className="gd-row-header-view">
                        ...
                        {description && <DashboardLayoutRowHeaderDescription description={description} />}
                    </div>
                )}
            </div>
        </div>
