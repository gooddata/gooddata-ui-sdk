...
export function generateRepeatString(repeatData: IScheduleEmailRepeat): string {
    ...
    const repeatDelimIndex = REPEAT_TYPE_BY_REPEAT_INDEX.indexOf(repeatBase);
    ...
    fragments[repeatDelimIndex - 1] = repeatPeriod;
    ...
    const reptParts = [
        fragments.slice(0, repeatDelimIndex),
        fragments.slice(repeatDelimIndex, fragments.length),
    ];
