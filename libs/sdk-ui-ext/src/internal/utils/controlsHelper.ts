...
import { bucketsFind, IInsightDefinition, insightBuckets, insightProperties } from "@gooddata/sdk-model";
...
export function isSetColumnHeadersPositionToLeftAllowed(insight: IInsightDefinition) {
    ...
    return !!columnAttribute && !rowAttribute && measureGroupDimension === "rows";
}
