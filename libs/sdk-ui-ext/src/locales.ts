...
export const titles: Record<string, MessageDescriptor> = defineMessages({
    ...
    measures_pushpin: { id: "dashboard.bucket.metric_title.pushpin" },
...
export const messages: Record<string, MessageDescriptor> = defineMessages({
    ...
    areaAutoDefaultInfo: { id: "properties.viewport.area.auto_default.info" },
    areaCustom: { id: "properties.viewport.area.custom" },
    areaCustomInfo: { id: "properties.viewport.area.custom.info" },
    ...
    rotation45: { id: "properties.rotation.45" },
    ...
    basemapDefault: { id: "properties.map.basemap.default" },
    basemapStandard: { id: "properties.map.basemap.standard" },
    basemapSatellite: { id: "properties.map.basemap.satellite" },
    basemapMonochrome: { id: "properties.map.basemap.monochrome" },
    basemapHybrid: { id: "properties.map.basemap.hybrid" },
    basemapNone: { id: "properties.map.basemap.none" },
    basemapNoneInfo: { id: "properties.map.basemap.noneInfo" },
    colorSchemeTitle: { id: "properties.map.colorScheme.title" },
    colorSchemeAutoDefault: { id: "properties.map.colorScheme.autoDefault" },
    colorSchemeLight: { id: "properties.map.colorScheme.light" },
    colorSchemeDark: { id: "properties.map.colorScheme.dark" },
    ...
    pointsShapeTitle: { id: "properties.points.shape.title" },
    pointsShapeTypeTitle: { id: "properties.points.shape.type.title" },
    shapeTypeCircle: { id: "properties.points.shape.type.circle" },
    shapeTypeIconByValue: { id: "properties.points.shape.type.iconByValue" },
    shapeTypeOneIcon: { id: "properties.points.shape.type.oneIcon" },
    pointsShapeIconTitle: { id: "properties.points.shape.icon.title" },
    shapeTypeIconByValueInfo: { id: "properties.points.shape.type.iconByValue.info" },
    shapeTypeOneIconInfo: { id: "properties.points.shape.type.oneIcon.info" },
    shapeTypeIconDisabled: { id: "properties.points.shape.type.icon.disabled" },
    ...
    fillOutline: { id: "properties.fill.outline" },
    ...
    canvasDistinctPointShapesLabel: { id: "properties.canvas.distinctPointShapes.label" },
    canvasDistinctPointShapesTooltip: { id: "properties.canvas.distinctPointShapes.tooltip" },
    ...
    columnHeaderWrapText: { id: "properties.column.headers.wrapText" },
    cellsTitle: { id: "properties.cells.title" },
    cellsWrapText: { id: "properties.cells.wrapText" },
    grandTotalsTitle: { id: "properties.cells.grandTotals.title" },
    grandTotalsPositionLabel: { id: "properties.cells.grandTotals.position.label" },
    grandTotalsPositionPinnedBottom: { id: "properties.cells.grandTotals.position.pinnedBottom" },
    grandTotalsPositionBottom: { id: "properties.cells.grandTotals.position.bottom" },
    grandTotalsPositionPinnedTop: { id: "properties.cells.grandTotals.position.pinnedTop" },
    pagingTitle: { id: "properties.paging.title" },
    pagingPageSize: { id: "properties.paging.pageSize" },
    pagingPageSizeAuto: { id: "properties.paging.pageSize.auto" },
    ...
    anomaliesTitle: { id: "properties.anomalies.title" },
    anomaliesDisabledTooltip: { id: "properties.anomaliesDisabled.title" },
    anomalySensitivityLow: { id: "properties.anomalySensitivity.low" },
    anomalySensitivityMedium: { id: "properties.anomalySensitivity.medium" },
    anomalySensitivityHigh: { id: "properties.anomalySensitivity.high" },
    anomalySensitivity: { id: "properties.anomalySensitivity.title" },
    anomalyPointSizeSmall: { id: "properties.anomalyPointSize.small" },
    anomalyPointSizeMedium: { id: "properties.anomalyPointSize.medium" },
    anomalyPointSizeBig: { id: "properties.anomalyPointSize.big" },
    anomalyPointSize: { id: "properties.anomalyPointSize.title" },
    anomaliesIndicator: { id: "properties.anomalyIndicator.title" },
    anomalyColor: { id: "properties.anomalyColor.color" },
