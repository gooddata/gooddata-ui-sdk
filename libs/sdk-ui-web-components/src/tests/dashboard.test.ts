...
describe("Dashboard", () => {
    ...
    it("registers gd-dashboard as the legacy runtime and gd-dashboard-embed as the strict runtime", async () => {
    ...
    it("renders legacy gd-dashboard directly instead of wrapping gd-dashboard-embed", async () => {
    ...
    it("should map embeddedOnly pluginMode to staticOnly and keep extraPlugins", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
    ...
    it("should map all pluginMode to adaptive and keep extraPlugins", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const extraPlugin: IEmbeddedPlugin = {
            factory: vi.fn(),
        };
    ...
    it("should map backendOnly pluginMode to adaptive, ignore extraPlugins and emit warning", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const moduleFederationIntegration = createModuleFederationIntegration();
        const props = createBridgeProps({
    ...
    it("should emit init error when backendOnly mode misses moduleFederationIntegration", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const props = createBridgeProps({
            pluginMode: "backendOnly",
        });
    ...
    it("should call onReady again when the same dashboard gets a new runtime instance", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const props = createBridgeProps({
            pluginMode: "embeddedOnly",
        });
    ...
    it("should call onReady again when dashboard identity changes", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
    ...
    it("should mount a successful loader result even when dashboard props resolve to an ObjRef-like value", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const props = createBridgeProps({
            pluginMode: "embeddedOnly",
        });
    ...
    it("should not re-emit the same invalid init error on rerender", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const onError = vi.fn();
    ...
    it("should not re-emit the same pluginMode warning on rerender", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
    ...
    it("should emit warning when embeddedOnly suppresses backend-linked plugins", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const backend = {
            workspace: vi.fn(() => ({
                dashboards: vi.fn(() => ({
    ...
    it("should not re-check backend-linked plugins when only onWarning callback identity changes", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
    ...
    it("should not dispatch ready after the dashboard runtime unmounts before the ready microtask runs", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const props = createBridgeProps({
            pluginMode: "embeddedOnly",
        });
    ...
    it("should not re-emit the same runtime loader error on rerender", async () => {
        const { DashboardLoaderBridge } = await import("../visualizations/internal/DashboardLoaderBridge.js");
        const onError = vi.fn();
        const baseProps = createBridgeProps({
            pluginMode: "embeddedOnly",
    ...
    it("should prefer property snapshots over bootstrap attributes for loader-backed dashboard props", async () => {
        const { setContext } = await import("../context.js");
    ...
    it("should emit gd-warning when disabled pluginMode suppresses extraPlugins", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
        ...
        element.addEventListener("gd-warning", (event) => {
            warnings.push(
                (event as CustomEvent<{ pluginMode: string; ignoredSource: string; message: string }>).detail,
            );
        });
    ...
    it("should forward dashboard runtime events through the loader-backed path", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
    ...
    it("should unregister forwarded dashboard runtime events when the loader-backed dashboard disconnects", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
    ...
    it("should only emit gd-ready once loader-backed command hooks are available", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
    ...
    it("should dispatch refresh after loader-backed runtime becomes command-ready", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
        ...
        expect(initializeDashboard).toHaveBeenCalledWith({ isReadOnly: true }, undefined, expect.any(String));
    ...
    it("should dispatch replaceFilters after loader-backed runtime becomes command-ready", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
    ...
    it("should reject commands after the loader-backed runtime becomes inactive", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
    ...
    it("should dispatch refresh through the dashboard command channel", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
    ...
    it("should reject failed replaceFilters commands and emit gd-error", async () => {
        const { setContext } = await import("../context.js");
        const { DashboardEmbed: DashboardElement } = await import("../visualizations/DashboardEmbed.js");
