...
export default {
    title: "04 Stories For Pluggable Vis/FunnelChart/customization/color",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "FunnelChart.8fc79843b9f3b1928ef01105b5e12d99",
                properties: {
                    controls: {
                        colorMapping: [
                            {
                ...
                sorts: [],
                title: "FunnelChart - assign color to measures",
                uri: "FunnelChart.8fc79843b9f3b1928ef01105b5e12d99",
                visualizationUrl: "local:funnel",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(9, 5, 0),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "FunnelChart.eb371d4d3e9deffd69976abde6392f99",
                properties: {
                    controls: {
                        colorMapping: [
                            {
                ...
                sorts: [],
                title: "FunnelChart - assign color to attributes",
                uri: "FunnelChart.eb371d4d3e9deffd69976abde6392f99",
                visualizationUrl: "local:funnel",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(9, 5, 1),
    )();
