    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "SankeyChart.7f0084af47a4b7b2096293d7ebb2d259",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "SankeyChart - data labels - default",
                uri: "SankeyChart.7f0084af47a4b7b2096293d7ebb2d259",
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "SankeyChart.3de3cff17ba2f232580a8f7dceba65c9",
                properties: {
                    controls: {
                        dataLabels: {
                            visible: "auto",
                ...
                sorts: [],
                title: "SankeyChart - data labels - auto visibility",
                uri: "SankeyChart.3de3cff17ba2f232580a8f7dceba65c9",
                visualizationUrl: "local:sankey",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "SankeyChart.995da609d542c0253b931f78086aa276",
                properties: {
                    controls: {
                        dataLabels: {
                            visible: true,
                ...
                sorts: [],
                title: "SankeyChart - data labels - forced visible",
                uri: "SankeyChart.995da609d542c0253b931f78086aa276",
                visualizationUrl: "local:sankey",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "SankeyChart.c0cd1545784e0d9da3d54cff7f8aa30a",
                properties: {
                    controls: {
                        dataLabels: {
                            visible: true,
                ...
                sorts: [],
                title: "SankeyChart - data labels - forced visible and german separators",
                uri: "SankeyChart.c0cd1545784e0d9da3d54cff7f8aa30a",
                visualizationUrl: "local:sankey",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "SankeyChart.9014d066544e853e1569a1b36974c483",
                properties: {
                    controls: {
                        dataLabels: {
                            visible: false,
                ...
                sorts: [],
                title: "SankeyChart - data labels - forced hidden",
                uri: "SankeyChart.9014d066544e853e1569a1b36974c483",
                visualizationUrl: "local:sankey",
            },
        } as unknown as IInsight,
