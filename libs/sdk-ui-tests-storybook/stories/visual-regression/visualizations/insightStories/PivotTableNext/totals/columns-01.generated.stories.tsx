...
export default {
    title: "04 Stories For Pluggable Vis/PivotTableNext/totals/columns",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.28ffb3523a88a0f57103c9c48035439f",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - single measure and single column grand total",
                uri: "PivotTableNext.28ffb3523a88a0f57103c9c48035439f",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 0),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.d878bab8cca1f7fb55a801204e730681",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - single measure and multiple column grand totals",
                uri: "PivotTableNext.d878bab8cca1f7fb55a801204e730681",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 1),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                identifier: "PivotTableNext.e963b4949bd2066f6be27a2ad81f2769",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - two measures and single column grand total for one",
                uri: "PivotTableNext.e963b4949bd2066f6be27a2ad81f2769",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 2),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.19f38ddb24bcba523a23b5d0208fbbe0",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - two measures and single column grand total for each",
                uri: "PivotTableNext.19f38ddb24bcba523a23b5d0208fbbe0",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 3),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.54d5c31ea9db99b6f6f4948dc668b1b4",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - two measures and multiple column grand totals for each",
                uri: "PivotTableNext.54d5c31ea9db99b6f6f4948dc668b1b4",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 4),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.3b747709d69a5182053196bce08d05a2",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - two measures and one column subtotal",
                uri: "PivotTableNext.3b747709d69a5182053196bce08d05a2",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 5),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                identifier: "PivotTableNext.c0d95bb5d60068a1048f1e7079f9856c",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - two measures and multiple column subtotals",
                uri: "PivotTableNext.c0d95bb5d60068a1048f1e7079f9856c",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 6),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                identifier: "PivotTableNext.a5f4a65b2bb75eb9b24a086f6fa28fdd",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTableNext - two measures and column grand totals and multiple subtotals",
                uri: "PivotTableNext.a5f4a65b2bb75eb9b24a086f6fa28fdd",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 11, 7),
    )();
