...
export default {
    title: "04 Stories For Pluggable Vis/PivotTableNext/manual-resizing/combined with growToFit and autoResize",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.1f92031de9e10dafdf0b0318799334ef",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                uri: "PivotTableNext.1f92031de9e10dafdf0b0318799334ef",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 8, 0),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.971af631f188c59bd80221fdaef2468f",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                uri: "PivotTableNext.971af631f188c59bd80221fdaef2468f",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 8, 1),
    )();
