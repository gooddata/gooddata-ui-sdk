...
export default {
    title: "04 Stories For Pluggable Vis/PivotTableNext/manual-resizing/combined with column autoresize",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.61ff9a4b65269f103f32e63d013c3b4f",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                uri: "PivotTableNext.61ff9a4b65269f103f32e63d013c3b4f",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 6, 0),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTableNext.a21c6cc8c8ed19f030f2d33502a0d024",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                uri: "PivotTableNext.a21c6cc8c8ed19f030f2d33502a0d024",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(18, 6, 1),
    )();
