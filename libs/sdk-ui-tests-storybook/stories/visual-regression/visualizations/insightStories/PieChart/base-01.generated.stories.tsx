...
export default {
    title: "04 Stories For Pluggable Vis/PieChart/base",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PieChart.865eeddb32d2ec3391ed80d3e64a54e9",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "PieChart - single measure",
                uri: "PieChart.865eeddb32d2ec3391ed80d3e64a54e9",
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PieChart.1449476de244ee9da929fd5b1171ec01",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "PieChart - two measures",
                uri: "PieChart.1449476de244ee9da929fd5b1171ec01",
                visualizationUrl: "local:pie",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PieChart.0e05315a5e594147314fe04efd07082b",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "PieChart - single measure with viewBy",
                uri: "PieChart.0e05315a5e594147314fe04efd07082b",
                visualizationUrl: "local:pie",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PieChart.b909ccdaafcb53af132ebfc23cefc661",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "PieChart - arithmetic measures",
                uri: "PieChart.b909ccdaafcb53af132ebfc23cefc661",
                visualizationUrl: "local:pie",
            },
        } as unknown as IInsight,
