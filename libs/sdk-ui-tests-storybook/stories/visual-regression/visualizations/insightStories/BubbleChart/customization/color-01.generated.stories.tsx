    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BubbleChart.ebf408e63f9aee60993e76d5a397e4f2",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "BubbleChart - coloring - custom palette",
                uri: "BubbleChart.ebf408e63f9aee60993e76d5a397e4f2",
                visualizationUrl: "local:bubble",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(2, 6, 1),
    )();
