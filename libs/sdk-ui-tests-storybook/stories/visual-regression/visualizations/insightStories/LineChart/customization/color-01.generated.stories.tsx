    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "LineChart.b832188c324a733fb5122f9fff36631f",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "LineChart - coloring - custom palette",
                uri: "LineChart.b832188c324a733fb5122f9fff36631f",
                visualizationUrl: "local:line",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(12, 10, 1),
    )();
