...
export default {
    title: "04 Stories For Pluggable Vis/ColumnChart/customization/color",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ColumnChart.56058d1d1601efbadc4e78ca5ee3402a",
                properties: {
                    controls: {
                        colorMapping: [
                            {
                ...
                sorts: [],
                title: "ColumnChart - assign color to measures",
                uri: "ColumnChart.56058d1d1601efbadc4e78ca5ee3402a",
                visualizationUrl: "local:column",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(4, 7, 0),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ColumnChart.4e23db0625a05b213f48f4b259fd160b",
                properties: {
                    controls: {
                        colorMapping: [
                            {
                ...
                sorts: [],
                title: "ColumnChart - assign color to master measure impacts derived PoP",
                uri: "ColumnChart.4e23db0625a05b213f48f4b259fd160b",
                visualizationUrl: "local:column",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(4, 7, 1),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ColumnChart.68a492ced997d45c37454002fdc735ab",
                properties: {
                    controls: {
                        colorMapping: [
                            {
                ...
                sorts: [],
                title: "ColumnChart - assign color to attribute element stack",
                uri: "ColumnChart.68a492ced997d45c37454002fdc735ab",
                visualizationUrl: "local:column",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(4, 7, 2),
    )();
