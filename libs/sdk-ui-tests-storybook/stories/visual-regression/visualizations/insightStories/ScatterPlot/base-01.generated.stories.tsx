...
export default {
    title: "04 Stories For Pluggable Vis/ScatterPlot/base",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ScatterPlot.1e8ea5cd5007cf4882be17f68da9b629",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "ScatterPlot - x axis measure",
                uri: "ScatterPlot.1e8ea5cd5007cf4882be17f68da9b629",
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ScatterPlot.a3ea50c901896d978cac7ff775a64ec3",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "ScatterPlot - x axis measure and attribute",
                uri: "ScatterPlot.a3ea50c901896d978cac7ff775a64ec3",
                visualizationUrl: "local:scatter",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ScatterPlot.bf22e6ff5552e057138f5b9409f3d573",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "ScatterPlot - y axis measure and attribute",
                uri: "ScatterPlot.bf22e6ff5552e057138f5b9409f3d573",
                visualizationUrl: "local:scatter",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ScatterPlot.fdaf3daba830a53221eeb82891197eb7",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "ScatterPlot - x and y axis measures and attribute",
                uri: "ScatterPlot.fdaf3daba830a53221eeb82891197eb7",
                visualizationUrl: "local:scatter",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ScatterPlot.02f16ac8fc6831e976c4503ba9cc1b90",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "ScatterPlot - x and y axis measures, attribute and segmentation",
                uri: "ScatterPlot.02f16ac8fc6831e976c4503ba9cc1b90",
                visualizationUrl: "local:scatter",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ScatterPlot.8d39dfbd910dc242152e796e1e09eb2f",
                properties: {
                    controls: {},
                },
                sorts: [
                ...
                title: "ScatterPlot - x and y axis measures and attribute with attr sorting",
                uri: "ScatterPlot.8d39dfbd910dc242152e796e1e09eb2f",
                visualizationUrl: "local:scatter",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ScatterPlot.43f04a05e8ba3ee3ffcf1d4d5bcc25c1",
                properties: {
                    controls: {},
                },
                sorts: [],
                title: "ScatterPlot - x and y axis measures and attribute with nulls in data",
                uri: "ScatterPlot.43f04a05e8ba3ee3ffcf1d4d5bcc25c1",
                visualizationUrl: "local:scatter",
            },
        } as unknown as IInsight,
