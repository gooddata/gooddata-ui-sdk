...
export default {
    title: "04 Stories For Pluggable Vis/GeoChart/customization/multi-layer/clusters",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                identifier: "GeoChart.ee8396cc7124a2c1c2732d0937591270",
                layers: [
                    {
                        buckets: [
                            {
                ...
                sorts: [],
                title: "GeoChart - area with clustered pushpin overlay",
                uri: "GeoChart.ee8396cc7124a2c1c2732d0937591270",
    ...
    plugVizStory(
        {
            insight: {
                ...
                identifier: "GeoChart.d91bd2fd68c58d0b2ea9b057476b1a38",
                layers: [
                    {
                        buckets: [
                            {
                ...
                sorts: [],
                title: "GeoChart - area with non-clustered pushpin overlay",
                uri: "GeoChart.d91bd2fd68c58d0b2ea9b057476b1a38",
                visualizationUrl: "local:choropleth",
            },
        } as unknown as IInsight,
