...
export default {
    title: "04 Stories For Pluggable Vis/ComboChart/customization/color",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ComboChart.2d9691c3890a541ab3d26650e28419b9",
                properties: {
                    controls: {
                        colorMapping: [
                            {
                ...
                sorts: [],
                title: "ComboChart - assign color to measures",
                uri: "ComboChart.2d9691c3890a541ab3d26650e28419b9",
                visualizationUrl: "local:combo2",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(5, 14, 0),
    )();
