    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "ComboChart.274bd3cfde195215fdb2f2a18334e251",
                properties: {
                    controls: {
                        dualAxis: false,
                    },
                ...
                sorts: [],
                title: "ComboChart - dual axis disabled",
                uri: "ComboChart.274bd3cfde195215fdb2f2a18334e251",
                visualizationUrl: "local:combo2",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(5, 12, 0),
    )();
