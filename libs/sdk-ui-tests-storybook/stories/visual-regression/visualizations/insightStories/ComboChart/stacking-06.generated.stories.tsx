...
export const StackMeasuresOffAndStackTo100On = () =>
    plugVizStory(
        {
            insight: {
                buckets: [
                ...
                filters: [],
                identifier: "ComboChart.a6ad8716a14e060d2e04b66ccf86fa8b",
                properties: {
                    controls: {
                        dualAxis: false,
                        stackMeasures: false,
                ...
                sorts: [],
                title: "ComboChart - 'Stack Measures' off and 'Stack to 100%' on",
                uri: "ComboChart.a6ad8716a14e060d2e04b66ccf86fa8b",
...
export const StackMeasuresOnAndStackTo100On = () =>
    plugVizStory(
        {
            insight: {
                buckets: [
                ...
                filters: [],
                identifier: "ComboChart.364549d95b959a06b083ee7cc068fe57",
                properties: {
                    controls: {
                        dualAxis: false,
                        stackMeasures: true,
                ...
                sorts: [],
                title: "ComboChart - 'Stack Measures' on and 'Stack to 100%' on",
                uri: "ComboChart.364549d95b959a06b083ee7cc068fe57",
                visualizationUrl: "local:combo2",
            },
        } as unknown as IInsight,
