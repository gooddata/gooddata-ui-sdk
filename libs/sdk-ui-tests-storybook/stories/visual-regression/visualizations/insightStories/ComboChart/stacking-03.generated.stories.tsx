...
export const StackPrimaryMeasuresWhenBothColumnChartNormalStacking = () =>
    plugVizStory(
        {
            insight: {
                buckets: [
                ...
                filters: [],
                identifier: "ComboChart.b5eef2a766c7c089941db284fed158bb",
                properties: {
                    controls: {
                ...
                sorts: [],
                title: "ComboChart - stack primary measures when both column chart - normal stacking",
                uri: "ComboChart.b5eef2a766c7c089941db284fed158bb",
...
export const StackPrimaryMeasuresWhenBothColumnChartStackTo100 = () =>
    plugVizStory(
        {
            insight: {
                buckets: [
                ...
                filters: [],
                identifier: "ComboChart.e74b514535d04212b743758c4ccc1c31",
                properties: {
                    controls: {
                        primaryChartType: "column",
                        secondaryChartType: "column",
                ...
                sorts: [],
                title: "ComboChart - stack primary measures when both column chart - stack to 100%",
                uri: "ComboChart.e74b514535d04212b743758c4ccc1c31",
                visualizationUrl: "local:combo2",
            },
        } as unknown as IInsight,
