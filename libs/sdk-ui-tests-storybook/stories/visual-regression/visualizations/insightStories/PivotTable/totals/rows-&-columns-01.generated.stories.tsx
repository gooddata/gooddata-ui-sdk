...
export default {
    title: "04 Stories For Pluggable Vis/PivotTable/totals/rows & columns",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.44c197353eefed217b514a40b4829fd7",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - single measure and single column/row grand total",
                uri: "PivotTable.44c197353eefed217b514a40b4829fd7",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 0),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.86767ba01e289567289ff3130e9f6a26",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - single measure and multiple column/row grand totals",
                uri: "PivotTable.86767ba01e289567289ff3130e9f6a26",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 1),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.1783a1a458d66ad974dd01fb3632a667",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - two measures and single column/row grand total for one",
                uri: "PivotTable.1783a1a458d66ad974dd01fb3632a667",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 2),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.f4e6daf76d4f96679de3ecbe4bb07088",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - two measures and single column/row grand total for each",
                uri: "PivotTable.f4e6daf76d4f96679de3ecbe4bb07088",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 3),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.5a9735a3559e39b3fb03b0ec7cef02bf",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - two measures and multiple column/row grand totals for each",
                uri: "PivotTable.5a9735a3559e39b3fb03b0ec7cef02bf",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 4),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.2b46ea2741016483e86154783ce54c94",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - two measures and one column/row subtotal",
                uri: "PivotTable.2b46ea2741016483e86154783ce54c94",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 5),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.8a844958f911b8032b3928533ed781cc",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - two measures and multiple column/row subtotals",
                uri: "PivotTable.8a844958f911b8032b3928533ed781cc",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 6),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.ebdaa11359007f93053adb4fa37e0351",
                properties: {
                    controls: {
                        columnWidths: [
                            {
                ...
                sorts: [],
                title: "PivotTable - two measures and column/row grand totals and multiple subtotals",
                uri: "PivotTable.ebdaa11359007f93053adb4fa37e0351",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(14, 13, 7),
    )();
