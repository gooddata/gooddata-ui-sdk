...
export default {
    title: "04 Stories For Pluggable Vis/PivotTable/grouping",
};
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.f859c3e05d9f78d4722bb20eabda7fc2",
                properties: {
                    controls: {},
                },
                sorts: [
                ...
                title: "PivotTable - single measure pivot with grouping sorted by first row attr",
                uri: "PivotTable.f859c3e05d9f78d4722bb20eabda7fc2",
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.030d176493ffa73f59df782329af3482",
                properties: {
                    controls: {},
                },
                sorts: [
                ...
                title: "PivotTable - single measure pivot with grouping sorted by second row attr",
                uri: "PivotTable.030d176493ffa73f59df782329af3482",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "PivotTable.142aa83b4fe0fffb84f1ce365e5bc35e",
                properties: {
                    controls: {},
                },
                sorts: [
                ...
                title: "PivotTable - single measure pivot with grouping sorted by measure",
                uri: "PivotTable.142aa83b4fe0fffb84f1ce365e5bc35e",
                visualizationUrl: "local:table",
            },
        } as unknown as IInsight,
