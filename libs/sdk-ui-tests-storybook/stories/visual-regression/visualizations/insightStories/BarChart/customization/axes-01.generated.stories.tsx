    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BarChart.ace8942b9cda5691366075554b4d89d4",
                properties: {
                    controls: {
                        xaxis: {
                            max: "25000000",
                ...
                sorts: [],
                title: "BarChart - X axis min/max configuration",
                uri: "BarChart.ace8942b9cda5691366075554b4d89d4",
                visualizationUrl: "local:bar",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(1, 3, 0),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BarChart.7b6cec05c593bb2e4584220b2f0327f0",
                properties: {
                    controls: {
                        secondary_xaxis: {
                            measures: [
                ...
                sorts: [],
                title: "BarChart - X axis on top",
                uri: "BarChart.7b6cec05c593bb2e4584220b2f0327f0",
                visualizationUrl: "local:bar",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(1, 3, 1),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BarChart.1dfb1fac9de09f419edfe90a283f1b35",
                properties: {
                    controls: {
                        secondary_xaxis: {
                ...
                sorts: [],
                title: "BarChart - dual axis with one top measure and three bottom",
                uri: "BarChart.1dfb1fac9de09f419edfe90a283f1b35",
                visualizationUrl: "local:bar",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(1, 3, 2),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BarChart.7c5b55e8bc104ea129c1dcd2a58a46b6",
                properties: {
                    controls: {
                        secondary_xaxis: {
                ...
                sorts: [],
                title: "BarChart - dual axis when two viewBy attributes",
                uri: "BarChart.7c5b55e8bc104ea129c1dcd2a58a46b6",
                visualizationUrl: "local:bar",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(1, 3, 3),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BarChart.6645e7061dab075a089f3be89ead8cc3",
                properties: {
                    controls: {
                        yaxis: {
                            rotation: "45",
                ...
                sorts: [],
                title: "BarChart - Y axis rotation",
                uri: "BarChart.6645e7061dab075a089f3be89ead8cc3",
                visualizationUrl: "local:bar",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(1, 3, 4),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BarChart.129269072f6e960a84668bc64df82b74",
                properties: {
                    controls: {
                        yaxis: {
                            visible: false,
                ...
                sorts: [],
                title: "BarChart - Y axis invisible",
                uri: "BarChart.129269072f6e960a84668bc64df82b74",
                visualizationUrl: "local:bar",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(1, 3, 5),
    )();
    ...
    plugVizStory(
        {
            insight: {
                ...
                filters: [],
                identifier: "BarChart.23f31688efd1c946f5ad35c360d1a207",
                properties: {
                    controls: {
                        secondary_xaxis: {
                            measures: [
                ...
                sorts: [],
                title: "BarChart - X axis on top with two viewBy attributes",
                uri: "BarChart.23f31688efd1c946f5ad35c360d1a207",
                visualizationUrl: "local:bar",
            },
        } as unknown as IInsight,
        getScenariosGroupByIndexes(1, 3, 6),
    )();
