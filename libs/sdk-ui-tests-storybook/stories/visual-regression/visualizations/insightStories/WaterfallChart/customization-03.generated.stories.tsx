...
export const DisableTotalColumn = () =>
    plugVizStory(
        {
            insight: {
                buckets: [
                ...
                filters: [],
                identifier: "WaterfallChart.5620cdf31981a82d1083c503eed9fa56",
                properties: {
                    controls: {
                        total: {
                            enabled: false,
                ...
                sorts: [],
                title: "WaterfallChart - disable total column",
                uri: "WaterfallChart.5620cdf31981a82d1083c503eed9fa56",
...
export const ChangeTheTotalColumnName = () =>
    plugVizStory(
        {
            insight: {
                buckets: [
                ...
                filters: [],
                identifier: "WaterfallChart.274539edc17aa55a9f34566c53b7af74",
                properties: {
                    controls: {
                        total: {
                            enabled: true,
                ...
                sorts: [],
                title: "WaterfallChart - change the total column name",
                uri: "WaterfallChart.274539edc17aa55a9f34566c53b7af74",
                visualizationUrl: "local:waterfall",
            },
        } as unknown as IInsight,
