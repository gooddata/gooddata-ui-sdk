...
export default {
    title: "01 Stories From Test Scenarios/PivotTable/manual-resizing/no other options",
};

export const SimpleTableWithCustomAttributeColumnSize = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(20, 9).asScenarioDescAndScenario();
