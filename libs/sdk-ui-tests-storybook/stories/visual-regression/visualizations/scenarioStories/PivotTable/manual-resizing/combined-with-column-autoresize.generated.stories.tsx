...
export default {
    title: "01 Stories From Test Scenarios/PivotTable/manual-resizing/combined with column autoresize",
};

export const SimpleTableWithCustomAttributeColumnSize = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(20, 6).asScenarioDescAndScenario();
