...
export default {
    title: "01 Stories From Test Scenarios/PivotTable/manual-resizing/combined with growToFit and autoResize",
};

export const SimpleTableWithCustomAttributeColumnSize = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(20, 8).asScenarioDescAndScenario();
