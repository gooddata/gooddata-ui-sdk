...
export default {
    title: "01 Stories From Test Scenarios/LineChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(11, 10), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(11, 11).asScenarioDescAndScenario();
