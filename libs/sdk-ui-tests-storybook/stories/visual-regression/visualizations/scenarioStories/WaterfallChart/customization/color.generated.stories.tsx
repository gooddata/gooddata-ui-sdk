...
export default {
    title: "01 Stories From Test Scenarios/WaterfallChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(18, 5), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(18, 6).asScenarioDescAndScenario();
