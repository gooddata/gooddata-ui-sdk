...
export default {
    title: "01 Stories From Test Scenarios/ScatterPlot/customization/axes",
};

export const YAxisMinMaxConfiguration = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(13, 2).asScenarioDescAndScenario();
...
export const AxisNameConfiguration = () =>
    groupedStory(getScenariosGroupByIndexes(13, 3), {
        width: 800,
        height: 400,
    })();
