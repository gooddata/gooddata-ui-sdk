...
export default {
    title: "01 Stories From Test Scenarios/PieChart/customization/responsive",
};

export const $300x250AutoDataLabels = () =>
    groupedStory(getScenariosGroupByIndexes(12, 14), {
        width: 300,
        height: 250,
    })();
...
export const $200x200WithoutDataLabels = () =>
    groupedStory(getScenariosGroupByIndexes(12, 15), {
        width: 200,
        height: 200,
    })();
