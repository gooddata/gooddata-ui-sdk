...
export default {
    title: "01 Stories From Test Scenarios/PieChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(12, 4), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(12, 5).asScenarioDescAndScenario();
