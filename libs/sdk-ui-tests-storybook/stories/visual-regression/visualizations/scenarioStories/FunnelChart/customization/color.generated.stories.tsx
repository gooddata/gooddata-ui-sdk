...
export default {
    title: "01 Stories From Test Scenarios/FunnelChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(7, 4), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(7, 5).asScenarioDescAndScenario();
