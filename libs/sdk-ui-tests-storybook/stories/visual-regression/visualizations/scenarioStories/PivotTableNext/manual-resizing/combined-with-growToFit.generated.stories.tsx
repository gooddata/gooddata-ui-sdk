...
export default {
    title: "01 Stories From Test Scenarios/PivotTableNext/manual-resizing/combined with growToFit",
};

export const SimpleTableWithCustomAttributeColumnSize = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(21, 7).asScenarioDescAndScenario();
