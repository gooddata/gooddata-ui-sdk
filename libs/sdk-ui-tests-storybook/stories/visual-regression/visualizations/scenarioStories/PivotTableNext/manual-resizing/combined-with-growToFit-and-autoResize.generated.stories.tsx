...
export default {
    title: "01 Stories From Test Scenarios/PivotTableNext/manual-resizing/combined with growToFit and autoResize",
};

export const SimpleTableWithCustomAttributeColumnSize = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(21, 8).asScenarioDescAndScenario();
