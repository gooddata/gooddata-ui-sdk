...
export default {
    title: "01 Stories From Test Scenarios/Treemap/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(14, 3), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToAttributes = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(14, 4).asScenarioDescAndScenario();
