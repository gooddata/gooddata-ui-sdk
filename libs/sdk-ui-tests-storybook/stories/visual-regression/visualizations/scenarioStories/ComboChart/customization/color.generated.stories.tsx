...
export default {
    title: "01 Stories From Test Scenarios/ComboChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(5, 13), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(5, 14).asScenarioDescAndScenario();
