...
export default {
    title: "01 Stories From Test Scenarios/BarChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(1, 7), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(1, 8).asScenarioDescAndScenario();
