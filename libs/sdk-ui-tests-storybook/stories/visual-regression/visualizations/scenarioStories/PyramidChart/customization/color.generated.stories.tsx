...
export default {
    title: "01 Stories From Test Scenarios/PyramidChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(8, 4), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(8, 5).asScenarioDescAndScenario();
