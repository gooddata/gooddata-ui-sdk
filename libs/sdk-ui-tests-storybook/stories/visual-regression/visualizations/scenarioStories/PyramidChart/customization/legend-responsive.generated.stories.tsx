...
export default {
    title: "01 Stories From Test Scenarios/PyramidChart/customization/legend responsive",
};

export const $180x154ForcePositionTopMax1RowGradientLegendMinimized = () =>
    groupedStory(getScenariosGroupByIndexes(8, 6), {
        width: 180,
        height: 154,
    })();
...
export const $260x154ForcePositionTopMax1RowGradientLegendMinimized = () =>
    groupedStory(getScenariosGroupByIndexes(8, 7), {
        width: 260,
        height: 154,
    })();
...
export const $180x300ForcePositionTopMax2RowsGradientLegendMinimized = () =>
    groupedStory(getScenariosGroupByIndexes(8, 8), {
        width: 180,
        height: 300,
    })();
...
export const $440x154ForcePositionTopMax1RowGradientLegendNormal = () =>
    groupedStory(getScenariosGroupByIndexes(8, 9), {
        width: 440,
        height: 154,
    })();
...
export const $610x154ForcePositionRight = () =>
    groupedStory(getScenariosGroupByIndexes(8, 10), {
        width: 610,
        height: 154,
    })();
...
export const $610x194PositionRespectsConfigurationMax1RowForTopBottom = () =>
    groupedStory(getScenariosGroupByIndexes(8, 11), {
        width: 610,
        height: 194,
    })();
...
export const $610x274PositionRespectsConfigurationMax2RowForTopBottom = () =>
    groupedStory(getScenariosGroupByIndexes(8, 12), {
        width: 610,
        height: 274,
    })();
...
export const $650x354PositionRespectsConfigurationMapLegendFitsInto1RowForTopBottom = () =>
    groupedStory(getScenariosGroupByIndexes(8, 13), {
        width: 650,
        height: 354,
    })();
