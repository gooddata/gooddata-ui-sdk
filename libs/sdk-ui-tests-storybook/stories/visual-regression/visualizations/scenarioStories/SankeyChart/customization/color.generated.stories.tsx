...
export default {
    title: "01 Stories From Test Scenarios/SankeyChart/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(15, 3), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToNodes = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(15, 4).asScenarioDescAndScenario();
