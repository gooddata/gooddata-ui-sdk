...
export default {
    title: "01 Stories From Test Scenarios/Heatmap/customization/color",
};

export const Coloring = () =>
    groupedStory(getScenariosGroupByIndexes(10, 4), {
        width: 800,
        height: 400,
    })();
Coloring.parameters = {
...
export const AssignColorToMeasures = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(10, 5).asScenarioDescAndScenario();
