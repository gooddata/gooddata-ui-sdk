...
export default {
    title: "01 Stories From Test Scenarios/DependencyWheelChart/customization/theme",
};

export const Themed = () =>
    (() => {
        const scenarios = getScenariosGroupByIndexes(16, 13).asScenarioDescAndScenario();
