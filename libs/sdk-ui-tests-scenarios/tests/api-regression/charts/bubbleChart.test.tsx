...
// file that pulls in `@gooddata/sdk-ui-charts` binds BubbleChart to the real CoreBubbleChart, which would
...
import { bubbleChart as bubbleChartScenarios } from "../../../src/scenarios/charts/bubbleChart/index.js";
