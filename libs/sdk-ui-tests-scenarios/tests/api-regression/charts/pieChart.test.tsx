...
import { pieChart as pieChartScenarios } from "../../../src/scenarios/charts/pieChart/index.js";
...
describe.skip("PieChart", () => {
    ...
    describe.each(Scenarios)("with %s", (_desc, scenario) => {
        ...
        it("should lead to same execution when rendered as insight via plug viz", async () => {
            ...
            const insight = createInsightDefinitionForChart("PieChart", _desc, interactions);
