...
import { funnelChart as funnelChartScenarios } from "../../../src/scenarios/charts/funnelChart/index.js";
...
describe.skip("FunnelChart", () => {
    ...
    describe.each(Scenarios)("with %s", (_desc, scenario) => {
        ...
        it("should lead to same execution when rendered as insight via plug viz", async () => {
            ...
            const insight = createInsightDefinitionForChart("FunnelChart", _desc, interactions);
