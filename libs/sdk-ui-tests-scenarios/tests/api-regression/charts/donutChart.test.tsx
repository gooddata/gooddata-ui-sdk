...
let { extractProps } = vi.hoisted(() => {
    ...
    // `DonutChart` may already be evaluated - and bound to the real `CoreDonutChart` - by the time this
...
import { donutChart as donutChartScenarios } from "../../../src/scenarios/charts/donutChart/index.js";
...
describe("DonutChart", () => {
    ...
    describe.each(Scenarios)("with %s", (_desc, scenario) => {
        ...
        it("should lead to same execution when rendered as insight via plug viz", async () => {
            ...
            const insight = createInsightDefinitionForChart("DonutChart", _desc, interactions);
