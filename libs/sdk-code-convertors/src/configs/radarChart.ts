...
/** @internal */
const DEFAULTS: ConfigDefaults<RadarChartConfigProperties> = {
    colorMapping: [],
    continuousLine: {
        enabled: false,
    },
...
/** @internal */
export const RADAR_CHART_DEFAULTS = DEFAULTS;

/** @internal */
export function radarChartLoad(props: VisualisationConfig<RadarChartConfigProperties>) {
            ...
            case "radarRenderAs":
                return [
                    [
                        "render_as",
                        getValueOrDefault(
                            value as (typeof DEFAULTS)["radarRenderAs"],
                            DEFAULTS.radarRenderAs,
                        ),
                    ],
                ];
            case "radarGridLineShape":
                return [
                    [
                        "grid_line_shape",
                        getValueOrDefault(
                            value as (typeof DEFAULTS)["radarGridLineShape"],
                            DEFAULTS.radarGridLineShape,
                        ),
                    ],
                ];
            case "dataLabels": {
...
/** @internal */
export function radarChartSave(
    ...
    return saveConfigObject({
        ...
        radarRenderAs: getValueOrDefault(config.render_as, DEFAULTS.radarRenderAs),
        radarGridLineShape: getValueOrDefault(config.grid_line_shape, DEFAULTS.radarGridLineShape),
