# Analytical Backend SPI implementation for the 'tiger' GoodData Platform
...
For more information, please see [LICENSE](https://github.com/gooddata/gooddata-ui-sdk/blob/master/libs/sdk-backend-tiger/LICENSE)
