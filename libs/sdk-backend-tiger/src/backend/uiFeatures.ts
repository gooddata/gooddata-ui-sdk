...
export enum TigerFeaturesNames {
    ...
    //boolean + possible values: enabled, disabled
    EnablePantherTheming = "enablePantherTheming",
}
...
export type ITigerFeatureFlags = {
    ...
    enablePantherTheming: typeof FeatureFlagsValues["enablePantherTheming"][number];
};
...
export const DefaultFeatureFlags: ITigerFeatureFlags = {
    ...
    enablePantherTheming: true, // TODO INE just for development
};
...
export const FeatureFlagsValues = {
    ...
    enablePantherTheming: [true, false] as const,
};
