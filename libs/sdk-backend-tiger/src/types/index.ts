...
import { ITigerClient, JsonApiOrganizationSettingPatchAttributesTypeEnum } from "@gooddata/api-client-tiger";
...
export type TigerSettingsType = JsonApiOrganizationSettingPatchAttributesTypeEnum;
