...
import {
    type JsonApiFactOutMeta,
    type JsonApiFactOutMetaOrigin,
    type JsonApiFactOutMetaOriginOriginTypeEnum,
...
export function getObjectOrigin<T = unknown>(obj: JsonApiMetadataLikeObject<T>): JsonApiFactOutMetaOrigin {
