...
const createDefaultDateFilterConfig = (enableToDateFilters = false): IDateFilterConfig => {
    return {
...
export const DefaultDateFilterConfig: IDateFilterConfig = createDefaultDateFilterConfig();

export const getDefaultDateFilterConfig = (enableToDateFilters = false): IDateFilterConfig => {
