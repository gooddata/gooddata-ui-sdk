...
export function DashboardPrecedenceScenario() {
    ...
    return (
        <WebComponentScenarioHarness
            ...
            hostAttributes={{
                dashboard: "missing-dashboard-bootstrap",
                workspace: "missing-workspace-bootstrap",
            }}
            onHostReady={(host) => {
                const dashboardHost = host as DashboardHost;

                dashboardHost.context = {
        ...
        >
            <div className="s-wc-bootstrap-dashboard-attribute">missing-dashboard-bootstrap</div>
            <div className="s-wc-bootstrap-workspace-attribute">missing-workspace-bootstrap</div>
            <div className="s-wc-bootstrap-dashboard-property">{Dashboards.KPIs}</div>
            <div className="s-wc-bootstrap-workspace-property">{workspace}</div>
