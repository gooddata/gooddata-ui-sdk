...
class WithAttributesCaching extends DecoratedWorkspaceAttributesService {
    ...
    public override getAttributeDisplayForms = async (
        ...
        const loadPromise = refsToLoad.length
            ...
            : Promise.resolve([] as IAttributeDisplayFormMetadataObject[]);
        ...
        withoutCacheHits.forEach((item) => {
            ...
            item.cacheHit = perRefPromise as Promise<IAttributeDisplayFormMetadataObject>;
        ...
        return outputRefs
            ...
            .filter((match): match is IAttributeDisplayFormMetadataObject => {
