...
export const ATTRIBUTE_AND_MEASURE_HEADERS_COLUMN = "ATTRIBUTE_AND_MEASURE_HEADERS_COLUMN";
export const ATTRIBUTE_AND_MEASURE_VALUES_COLUMN = "ATTRIBUTE_AND_MEASURE_VALUES_COLUMN";
