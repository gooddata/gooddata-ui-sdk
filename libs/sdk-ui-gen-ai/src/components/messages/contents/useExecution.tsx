...
import {
    ...
    type GenAIAbsoluteDateFilter,
    type GenAIDateGranularity,
    type GenAIFilter,
    type GenAIMetricType,
    type GenAINegativeAttributeFilter,
    type GenAIPositiveAttributeFilter,
    type GenAIRankingFilter,
    type GenAIRelativeDateFilter,
    type IAttribute,
    type IFilter,
    type IGenAIVisualization,
    type IGenAIVisualizationMetric,
    type IMeasure,
