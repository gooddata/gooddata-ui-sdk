...
const customHighlightStyle = HighlightStyle.define([
    ...
    { tag: [customTags.invalidAttribute, customTags.invalidFilter, customTags.invalidIdentifier], class: "cm-invalid" },
]);
...
const buildValidInsightFiltersFormattingRule = (attributeFilters: IAttributeFilter[]) => {
    ...
    const validInsightAttributeFilterPlaceholders = attributeFilters
        ...
        .join("|");
    return { regex: new RegExp(`^${validInsightAttributeFilterPlaceholders}`), token: customTags.filter.toString() };
};
...
const buildValidDashboardFiltersFormattingRule = (
    ...
    return { regex: new RegExp(`^${validDashboardAttributeFilterPlaceholders}`), token: customTags.filter.toString() };
};
