 ...
 * once `useAlertingDialogContext().isLoading` is false for the first time — the state hooks throw until
 * the dialog's data has first loaded (after that they stay available through a refresh) — and render the
