...
/**
 * Default render of the scheduled-export dialog's header region: the back button and the title input
 * with its length validation. Props-driven — reads no scheduled-email dialog state. The default dialog and
