 ...
 * a concrete timezone.
 *
 * Default render of that section; its props are the slot contract
 * ({@link IScheduledEmailDialogTimezoneProps}). Props-driven — reads no scheduled-email dialog state. The default dialog
