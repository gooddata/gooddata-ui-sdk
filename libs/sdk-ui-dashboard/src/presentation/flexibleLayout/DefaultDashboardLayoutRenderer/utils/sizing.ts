...
export const determineSizeForScreenFromSizingLayoutItem = (
    screen: ScreenSize,
    ...
    const providedSizeForScreen = sizingLayoutItem ? sizingLayoutItem.size()[screen] : undefined;
