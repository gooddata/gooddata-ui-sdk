...
import React from "react"; // useMemo, useCallback
...
export const DefaultDashboardRichTextWidget: React.FC<IDefaultDashboardRichTextWidgetProps> = (props) => {
    return <DefaultDashboardRichTextWidgetCore {...props} />;
};

/**
 * @internal
 */
const DefaultDashboardRichTextWidgetCore: React.FC<IDefaultDashboardRichTextWidgetProps> = ({
    // widget,
    screen,
    // onError,
    // onLoadingChanged,
