...
import { KpiPlaceholderConfigurationPanel } from "../../kpiPlaceholder/KpiPlaceholderConfigurationPanel.js";

/**
 * @internal
 */
export const DefaultDashboardStackPlaceholderWidget: CustomDashboardWidgetComponent = (props) => {
