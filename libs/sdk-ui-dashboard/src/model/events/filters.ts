...
export function attributeFilterAdded(
    ...
    return {
        type: "GDC.DASHBOARD.EVT.AF.ADDED",
        ctx,
        correlationId,
        payload: {
            added,
...
export function attributeFilterRemoved(
    ...
    return {
        type: "GDC.DASHBOARD.EVT.AF.REMOVED",
        ctx,
        correlationId,
        payload: {
            removed,
...
export function attributeFilterMoved(
    ...
    return {
        type: "GDC.DASHBOARD.EVT.AF.MOVED",
        ctx,
        correlationId,
        payload: {
            moved,
...
export function attributeFilterSelectionChanged(
    ...
    return {
        type: "GDC.DASHBOARD.EVT.AF.SELECTION_CHANGED",
        ctx,
        correlationId,
        payload: {
            filter,
...
export function attributeFilterParentChanged(
    ...
    return {
        type: "GDC.DASHBOARD.EVT.AF.PARENT_CHANGED",
        ctx,
        correlationId,
        payload: {
            filter,
...
export function filterContextChanged(
    ...
    return {
        type: "GDC.DASHBOARD.EVT.F.FILTER_CONTEXT_CHANGED",
        ctx,
        correlationId,
        payload: {
            filterContext,
