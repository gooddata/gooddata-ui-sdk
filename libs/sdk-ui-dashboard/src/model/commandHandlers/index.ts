...
import { handleSetWidgetToShowAsTable } from "./widgetsToShowAsTable/widgetsToShowAsTableHandler.js";
...
export const DefaultCommandHandlers: {
    ...
    "GDC.DASH/CMD.WIDGETS_TO_SHOW_AS_TABLE.SET": handleSetWidgetToShowAsTable,
};
