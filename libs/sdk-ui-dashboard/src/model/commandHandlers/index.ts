...
export const DefaultCommandHandlers: {
    ...
    "GDC.DASH/CMD.FILTER_CONTEXT.FILTER_VIEW.SET_AS_DEFAULT": setFilterViewAsDefaultHandler,
    "GDC.DASH/CMD.FILTER_CONTEXT.FILTER_VIEW.RELOADS": reloadFilterViewsHandler,
};
