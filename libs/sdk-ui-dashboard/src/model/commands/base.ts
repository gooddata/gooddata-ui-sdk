...
export type DashboardCommandType =
    ...
    | "GDC.DASHBOARD.CMD.DF.CHANGE_SELECTION"
    ...
    | "GDC.DASHBOARD.CMD.FL.ADD_SECTION"
    | "GDC.DASHBOARD.CMD.FL.MOVE_SECTION"
    | "GDC.DASHBOARD.CMD.FL.REMOVE_SECTION"
    | "GDC.DASHBOARD.CMD.FL.CHANGE_SECTION_HEADER"
    | "GDC.DASHBOARD.CMD.FL.ADD_ITEMS"
    | "GDC.DASHBOARD.CMD.FL.REPLACE_ITEM"
    | "GDC.DASHBOARD.CMD.FL.MOVE_ITEM"
    | "GDC.DASHBOARD.CMD.FL.REMOVE_ITEM"
    | "GDC.DASHBOARD.CMD.FL.UNDO";
