 ...
 *
 * Doing the same two resets ourselves at the end of every file gives each file the clean module
 * graph it would get under isolation, while still reusing the worker and its DOM.
 */
afterAll(() => {
