    ...
    describe("with fake server", () => {
        ...
        describe("getDomain", () => {
            it("should reject with 400 when domain resource fails", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId", 400);
            ...
            it("should return domain", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId", {
                    status: 200,
                    body: {
                        domain: {
                            name: "domainId",
        ...
        describe("getDomains", () => {
            ...
            it("should return domains", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains", {
                    status: 200,
                    body: {
                        domains: {
                            items: [
                                {
                                    domain: {
                                        ...
                                        links: {
                                            ...
                                            users:
                                                "/gdc/admin/contracts/contractId/domains/data-admin-test1/users",
                                            projects:
                                                "/gdc/admin/contracts/contractId/domains/data-admin-test1/projects", // tslint:disable-line:max-line-length
                                        },
                                    },
                                },
                                {
                                    domain: {
                                        ...
                                        links: {
                                            ...
                                            users:
                                                "/gdc/admin/contracts/contractId/domains/data-admin-test2/users",
                                            projects:
                                                "/gdc/admin/contracts/contractId/domains/data-admin-test2/projects", // tslint:disable-line:max-line-length
                                        },
                                    },
                                },
                            ],
        ...
        describe("getDomainProjects", () => {
            it("should reject with 400 when projects resource fails", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId/projects", 400);
            ...
            it("should return domains projects", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId/projects", {
                    status: 200,
                    body: JSON.stringify({
                        domainProjects: {
            ...
            it("should return disabled domain projects", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId/projects?state=disabled", {
                    status: 200,
                    body: JSON.stringify({
                        domainProjects: {
                            items: [{ project: { title: "project0" } }, { project: { title: "project1" } }],
            ...
            it("should use paging next when getting result", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId/projects?limit=10", {
                    status: 200,
                    body: JSON.stringify({
                        domainProjects: {
                            items: [{ project: { title: "project0" } }, { project: { title: "project1" } }],
                ...
                return createDomains()
                    .getDomainProjects("contractId", "domainId", null, null, {
        ...
        describe("getDomainUsers", () => {
            ...
            it("should reject with 400 when resource fails", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId/users", 400);
            ...
            it("should return domain users", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId/users", {
                    status: 200,
                    body: usersPayload,
                });
            ...
            it("should use paging next when getting result", () => {
                fetchMock.mock("/gdc/admin/contracts/contractId/domains/domainId/users?limit=10", {
                    status: 200,
                    body: usersPayload,
                });

                return createDomains()
                    .getDomainUsers("contractId", "domainId", null, {
