...
export const TIME_FORMAT_WITH_SECONDS_WITH_SEPARATOR = ", HH:mm:ss";

export const DAY_START_TIME = "00:00";
export const DAY_END_TIME = "23:59";
export const DAY_START_TIME_WITH_SECONDS = "00:00:00";
export const DAY_END_TIME_WITH_SECONDS = "23:59:59";
