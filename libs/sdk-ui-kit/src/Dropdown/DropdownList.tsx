...
export interface IDropdownListProps<T> extends IListProps<T> {
    ...
    renderNoData?: (props: { hasNoMatchingData: boolean }) => React.ReactNode;
...
export class DropdownList<T> extends Component<IDropdownListProps<T>> {
    public render(): React.ReactNode {
        ...
        const renderFooter = () => {
            const { footer, closeDropdown } = this.props;
                        ...
                        {(autoSize) => {
                            ...
                            return (
                                <List
                                    ...
                                    itemHeight={
                                        isMobile ? Math.max(mobileItemHeight, itemHeight) : itemHeight
                                    }
                                    {...listProps}
                                />
                            );
