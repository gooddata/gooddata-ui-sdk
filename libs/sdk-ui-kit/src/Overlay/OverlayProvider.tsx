...
const handleOnScrollEvent = throttle((node: HTMLElement) => fireGoodstrapScrollEvent(node, window), 13);
...
export const OverlayProvider: React.FC<IOverlayProviderProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            */}
            <div id={overlaysRootId} style={{ position: "relative", height: "100%" }} ref={setElementRef}>
                {children}
