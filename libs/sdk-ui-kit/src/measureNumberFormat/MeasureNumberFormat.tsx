 ...
 * @internal
 */
export interface MeasureNumberFormatProps {
...
const WrappedMeasureNumberFormat = memo(function WrappedMeasureNumberFormat({
    ...
    const customPreset = useMemo(() => getCustomFormatPreset(), [getCustomFormatPreset]);
 ...
 * @internal
 */
export const MeasureNumberFormat = memo(function MeasureNumberFormat(props: MeasureNumberFormatProps) {
    return (
