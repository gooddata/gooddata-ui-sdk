 ...
 */
export const LegacyMultiSelectListItem: NamedExoticComponent<ILegacyMultiSelectListItemProps> = memo(
    function LegacyMultiSelectListItem({
        onMouseOver = () => {},
        onMouseOut = () => {},
        onOnly = () => {},
        onSelect = () => {},
        ...
        const classNames = useMemo(
            () =>
                cx({
                    "gd-list-item": true,
                    [`s-${simplifyText(source.title)}`]: true,
