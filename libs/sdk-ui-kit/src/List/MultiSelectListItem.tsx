...
import { type MouseEvent, type NamedExoticComponent, memo, useCallback, useMemo } from "react";
 ...
 * @internal
 */
export const MultiSelectListItem: NamedExoticComponent<IMultiSelectListItemProps> = memo(
