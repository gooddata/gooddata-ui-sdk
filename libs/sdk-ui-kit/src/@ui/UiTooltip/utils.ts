...
import { ARROW_WIDTH, ARROW_EDGE_OFFSET, oppositeSides } from "./constants.js";
...
export const computeTooltipShift = (
    ...
    const borderArrowOffset = ARROW_EDGE_OFFSET + ARROW_WIDTH / 2;
...
export const computeArrowOffset = (
    ...
    if (isEnabled) {
        ...
        if (axisPlacement === "start") {
            return ARROW_EDGE_OFFSET;
        } else if (axisPlacement === "end") {
            return sideLength - (ARROW_WIDTH + ARROW_EDGE_OFFSET);
        }
    }
    return 0;
};
