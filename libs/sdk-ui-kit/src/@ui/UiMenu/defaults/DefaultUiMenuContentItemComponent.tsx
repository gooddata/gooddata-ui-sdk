 ...
 * @internal
 */
export const DefaultUiMenuContentItemWrapperComponent = React.memo(function DefaultUiMenuContentItemComponent<
 ...
 * @internal
 */
export function DefaultUiMenuContentItemComponent<T extends IUiMenuItemData = object>({
    item,
    isFocused,
    onSelect,
