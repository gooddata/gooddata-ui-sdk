...
import { GranteeUserIcon } from "../../ShareDialog/ShareDialogBase/GranteeIcons.js";
    ...
    return (
        <BubbleHoverTrigger showDelay={0} hideDelay={0} className="gd-grantee-item-delete">
            ...
            <Bubble className="bubble-primary" alignPoints={alignPoints}>
                {mode === "VIEW"
                    ? intl.formatMessage(userManagementMessages.removeSavedUserTooltip)
                    : intl.formatMessage(userManagementMessages.removeUnsavedUserTooltip)}
            </Bubble>
        </BubbleHoverTrigger>
    );
};
