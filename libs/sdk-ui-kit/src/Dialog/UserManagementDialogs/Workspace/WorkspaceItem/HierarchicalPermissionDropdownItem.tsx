...
import { userManagementHierarchicalPermissionMessages } from "../../../../locales.js";
    ...
    return (
        ...
        >
            <div>
                {intl.formatMessage(
                    isHierarchicalPermission
                        ? userManagementHierarchicalPermissionMessages.enabled
                        : userManagementHierarchicalPermissionMessages.disabled,
                )}
            </div>
