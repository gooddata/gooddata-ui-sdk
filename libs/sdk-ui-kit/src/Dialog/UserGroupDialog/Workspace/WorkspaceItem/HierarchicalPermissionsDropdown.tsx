...
const Dropdown: React.FC<IGranularPermissionsDropdownProps> = ({
    ...
    const [selectedPermission, setSelectedPermission] = useState<boolean>(
        workspace.isHierarchical,
    );
    ...
    const buttonValue = intl.formatMessage(hierarchicalPermissionMessageLabels[selectedPermission ? "enabled" : "disabled"]);
