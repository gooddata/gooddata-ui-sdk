...
import { ISelectErrorOption, isSelectErrorOption } from '../../ShareDialog/ShareDialogBase/types.js';
import { Typography } from '../../../Typography/index.js';
import { LoadingMask } from '../../../LoadingMask/index.js';
import { isGroupItem, IGroupSelectOption } from "../types.js";
import { getGroupItemTestId } from "../utils.js";
...
export const MenuListRendered = (props: MenuListProps<IGroupSelectOption, false>): JSX.Element => {
    return (
...
const OptionContentRenderer = (item: IGroupSelectOption): JSX.Element => {
    return <> {item.label} </>;
};
...
export const OptionRenderer = (props: OptionProps<IGroupSelectOption, false>): JSX.Element => {
    ...
    const sTestStyle = isGroupItem(data.value) ?  getGroupItemTestId(data.value) : "";
