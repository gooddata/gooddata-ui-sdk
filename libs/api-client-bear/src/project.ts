...
export interface IProjectModule {
    ...
    setTimezone(projectId: string, timezone: ITimezone): any;
 ...
 *
 */
export class ProjectModule implements IProjectModule {
    ...
    protected parseProjectFeatureFlags(
        settingItems: IProjectConfigSettingItem[],
        source?: string,
    ): IFeatureFlags {
