...
export type {
    ...
    ConversationInteractionRoleEnum,
    ActiveObjectIdentification,
    CreatedVisualizationInteractionWithContextUserFeedbackEnum,
    FoundObjectInteractionWithContextUserFeedbackEnum,
    TextInteractionWithContextUserFeedbackEnum,
