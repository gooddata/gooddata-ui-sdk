...
export interface ChatHistoryInteraction {
    ...
    question: string;
    /**
     * Chat History thread ID. Backend persists chat history and returns ID for further requests.
     * @type {string}
     * @memberof ChatHistoryInteraction
     */
    threadId: string;
...
export interface ChatHistoryRequest {
    /**
     * Chat History thread ID. Optional, backend can create it if not provided.
     * @type {string}
