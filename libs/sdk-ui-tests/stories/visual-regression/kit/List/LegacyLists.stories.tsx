...
function LegacyListExamples() {
    ...
    const renderInvertableListWithLimitException = () => {
        return (
    ...
    const renderInvertableListInLoadingState = () => {
        return <LegacyInvertableList {...defaultListProps} isLoading showSearchField={false} />;
    };

    const renderInvertableListWithNoItemsFound = () => {
