...
function BubbleExamples() {
    ...
    useEffect(() => {
        ...
        const interval = window.setInterval(() => {
            setDots((currentDots) => (currentDots.length >= 15 ? "" : `${currentDots}...`));
        }, 3000);
    ...
    return (
        <div className="library-component screenshot-target">
            ...
            <div className="bubble-align-example bubble-align-point-example">
                <div className="bubble-align-example-target">{renderAlignPoints()}</div>
            </div>
