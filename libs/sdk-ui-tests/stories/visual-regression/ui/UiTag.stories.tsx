...
import { UiTag, UiTagProps, IUiTagAccessibilityConfig } from "@gooddata/sdk-ui-kit";
        ...
        <div className="library-component screenshot-target">
            ...
            <Example title="Long tag">
                <div style={{ ...sx, flexWrap: "wrap" }}>
                    ...
                    />
                    <UiTag variant="solid" isDeletable={true} size="small" {...defaultProps} label="Tag" />
                </div>
            </Example>
        </div>
    </IntlProvider>
...
export const Default = () => <UiTagExamples />;
