...
export const toastMessageThemeVariables = [
    ...
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-textColor",
        themePath: ["toastMessage", "progress", "textColor"],
        defaultValue: "var(--gd-palette-complementary-0, #fff)",
    },
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-backgroundColor",
        themePath: ["toastMessage", "progress", "backgroundColor"],
        defaultValue:
            "var(--gd-palette-info-base-t02, var(--gd-palette-primary-base-t02, rgba(20, 178, 226, 0.98)))",
    },
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-borderColor",
        themePath: ["toastMessage", "progress", "borderColor"],
        defaultValue: "transparent",
    },
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-borderWidth",
        themePath: ["toastMessage", "progress", "borderWidth"],
        defaultValue: "0",
    },
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-borderRadius",
        themePath: ["toastMessage", "progress", "borderRadius"],
        defaultValue: "3px",
    },
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-dropShadow",
        themePath: ["toastMessage", "progress", "dropShadow"],
        defaultValue: null,
    ...
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-closeButtonColor",
        themePath: ["toastMessage", "progress", "closeButtonColor"],
        defaultValue: "var(--gd-palette-complementary-0, #fff)",
    },
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-linkButtonColor",
        themePath: ["toastMessage", "progress", "linkButtonColor"],
        defaultValue: "rgba(255, 255, 255, 0.85)",
    },
    {
        type: "theme",
        variableName: "--gd-toastMessage-progress-separatorLineColor",
        themePath: ["toastMessage", "progress", "separatorLineColor"],
        defaultValue: "var(--gd-palette-complementary-0, #fff)",
    },
