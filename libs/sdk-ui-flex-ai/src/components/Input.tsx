...
export const Input: React.FC<InputProps> = () => {
    ...
    const buttonClasses = cx("gd-flex-ai-chat__input__send_button", {
        "gd-flex-ai-chat__input__send_button--disabled": disabled || !value,
    });

    return (
        <div className="gd-flex-ai-chat__input">
            <TextareaAutosize
                ref={textareaRef}
                className="gd-flex-ai-chat__input__textarea"
