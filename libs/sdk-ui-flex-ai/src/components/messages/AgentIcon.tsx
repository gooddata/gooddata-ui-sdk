...
export const AgentIcon: React.FC<AgentStateIconProps> = ({ loading = false }) => {
    ...
    const className = cx("gd-flex-ai-chat__agent_icon", {
        "gd-flex-ai-chat__agent_icon--loading": loading,
        "gd-flex-ai-chat__agent_icon--appear": !loading,
    });
    ...
    return (
        <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath={`url(#clip_mask_${instanceId})`}>
                {loading ? (
                    <g className="gd-flex-ai-chat__agent_icon__circle">
                    ...
                    <circle cx="16" cy="16" r="16" className="gd-flex-ai-chat__agent_icon__background" />
                )}
                <path
                    className="gd-flex-ai-chat__agent_icon__star"
                ...
                />
                <path
                    className="gd-flex-ai-chat__agent_icon__star gd-flex-ai-chat__agent_icon__star--flickr"
                ...
                />
                <path
                    className="gd-flex-ai-chat__agent_icon__star gd-flex-ai-chat__agent_icon__star--flickr gd-flex-ai-chat__agent_icon__star--flickr--delay"
            ...
            <defs>
                <linearGradient
                    ...
                    y2="0"
                >
                    <stop offset="0%" className="gd-flex-ai-chat__agent_icon__grad--from" />
                    <stop offset="100%" className="gd-flex-ai-chat__agent_icon__grad--mid" />
                </linearGradient>
                <linearGradient
                    className="gd-flex-ai-chat__agent_icon__grad2"
                    ...
                    y2="1"
                >
                    <stop offset="0%" className="gd-flex-ai-chat__agent_icon__grad--mid" />
                    <stop offset="100%" className="gd-flex-ai-chat__agent_icon__grad--to" />
                </linearGradient>
