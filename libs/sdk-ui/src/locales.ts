...
export const messages: Record<string, MessageDescriptor> = defineMessages({
    ...
    hierarchyCreateFailedMessage: { id: "attributeHierarchyEditor.message.create.failed" },
    hierarchyDeleteFailedMessage: { id: "attributeHierarchyEditor.message.delete.failed" },
    hierarchyUpdateFailedMessage: { id: "attributeHierarchyEditor.message.update.failed" },
    ...
    mvfPreviewAnd: { id: "mvf.preview.and" },
    mvfPreviewOr: { id: "mvf.preview.or" },
});
