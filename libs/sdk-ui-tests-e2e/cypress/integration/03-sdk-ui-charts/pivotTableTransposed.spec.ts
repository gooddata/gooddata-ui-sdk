...
describe(
    ...
    () => {
        ...
        it(
            ...
            () => {
                visit("visualizations/pivot-table/pivot-table-transposed-has-mr-row-top");
                table
                    .waitLoaded()
...
describe("Insight View", { tags: ["checklist_integrated_tiger_be", "checklist_integrated_tiger_fe"] }, () => {
    ...
    it.skip("should display Metric in row, Column header on left", () => {
        visit("insight/insight-transpose-has-mc-row-left");
    ...
    it("should display Metric in column, Column header on the top", () => {
        visit("insight/insight-transpose-has-mc-column-top");
        table
            .waitLoaded()
