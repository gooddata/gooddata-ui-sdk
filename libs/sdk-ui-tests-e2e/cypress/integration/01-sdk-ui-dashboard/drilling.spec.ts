...
describe("Interaction", () => {
    ...
    it(
        ...
        () => {
            ...
            //Write test with table insight here.

            const widget2 = new Widget(2);
            widget2.scrollIntoView().waitChartLoaded().click();
            widgetConfig.openInteractions().addInteraction("Sum of Amount", "measure");
            widgetConfig
