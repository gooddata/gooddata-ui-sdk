...
const currentTag = Cypress.env("grepTags");

describe(
    "Export dashboard to pdf",
    { tags: ["checklist_integrated_tiger_export", "checklist_integrated_new_feature"] },
    () => {
            ...
            cy.fixture("dashboardInfosForExport").then((data) => {
                data["validInsightsForTigerPDFExport"].forEach(
                    (dashboardInfo: {
                        ...
                        if (currentTag === "checklist_integrated_new_feature") {
                            Navigation.visit(dashboardInfo.dashboardURL, { enableSlideshowExports: true });
                        } else {
