...
import { assertSaveButtonEnabled, enterEditMode, saveDashboard, visit, visitCopyOf } from "../helpers.js";
    ...
    () => {
        ...
        test(
            ...
            async ({ page }) => {
                ...
                const dropdown = page.locator(".s-extended-date-filters-body");
                await expect(
                    dropdown.locator(".gd-extended-date-filter-edit-mode-message-text"),
                ).toBeHidden();
