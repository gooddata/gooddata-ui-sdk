    ...
    () => {
        test(
            ...
            async ({ page }) => {
                ...
                // Hyperlink in cell 1
                await expect(cells.nth(1).locator("a.gd-repeater-link")).toContainText(
                    "Show more when clicking",
                );
        ...
        test(
            ...
            async ({ page }) => {
                ...
                // Hyperlink in cell 6
                await expect(cells.nth(6).locator("a.gd-repeater-link")).toContainText(
                    "Show more when clicking",
                );
