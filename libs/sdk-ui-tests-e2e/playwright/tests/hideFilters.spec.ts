...
test.topLevelDescribe(
    ...
    () => {
        ...
        test(
            "Hide hidden attribute filter on view mode",
        ...
        test(
            ...
            async ({ page }) => {
                ...
                await page.locator(".s-gd-date-filter-configuration-button").click();
                await expect(
                    page.locator(".s-configuration-item-mode .s-config-state-hidden"),
                ...
                await selectFilterConfiguration(page);
                await expect(
                    page.locator(".s-configuration-item-mode .s-config-state-active"),
                ).toHaveAttribute("checked", "");
                ...
                await selectFilterConfiguration(page);
                await expect(
                    page.locator(".s-configuration-item-mode .s-config-state-readonly"),
                ).toHaveAttribute("checked", "");
            },
        );
