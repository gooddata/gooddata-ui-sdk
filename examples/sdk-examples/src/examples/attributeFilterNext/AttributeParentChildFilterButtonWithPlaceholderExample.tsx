...
const AttributeParentChildFilterButtonWithPlaceholder: React.FC = () => {
    ...
    /**
     * What happens with the component depending on the child filters is handled outside the AttributeFilterButtonV2 component.
     */
    useEffect(() => {
        setChildFilter(
            newNegativeAttributeFilter(attributeDisplayFormRef(Md.LocationCity), {
    ...
    return (
        <div className="s-attribute-filter">
            <div style={{ display: "flex" }}>
                <AttributeFilterButtonV2 connectToPlaceholder={stateFilterPlaceholder} onError={onError} />
