...
import { workspace, columnInsightViewIdentifier } from "../../constants/fixtures";
...
export const InsightViewColumnChartByIdentifierExample: React.FC = () => {
    ...
    return (
        <div style={style} className="s-insightView-chart">
            <InsightView backend={backend} workspace={workspace} insight={columnInsightViewIdentifier} />
        </div>
    );
};
