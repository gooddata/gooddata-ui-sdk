...
const greaterThanFilter = newMeasureValueFilter(MdExt.FranchisedSales, "GREATER_THAN", 7000000);

const betweenFilter = newMeasureValueFilter(MdExt.FranchisedSales, "BETWEEN", 5000000, 8000000);
