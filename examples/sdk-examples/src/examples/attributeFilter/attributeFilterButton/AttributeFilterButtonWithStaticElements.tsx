...
export const AttributeFilterButtonWithStaticElements = () => {
    const [filter, setFilter] = useState<IAttributeFilter>(newNegativeAttributeFilter(Md.LocationCity, []));

    return <AttributeFilterButton filter={filter} staticElements={staticElements} onApply={setFilter} />;
};

export default AttributeFilterButtonWithStaticElements;
