...
export const Sorting = () => (
    <div>
        <h1>Sorting</h1>
        <p>These examples show how to sort bucket components like <code>ColumnChart or Table</code>.</p>

        <hr className="separator" />

        <h2>Sorting by Measure</h2>
        <p>You can sort data by a measure value with the <code>measureSortItem</code>.</p>
        <ExampleWithSource for={MeasureSortingExample} source={MeasureSortingExampleSRC} />

        <hr className="separator" />

        <h2>Sorting by Attribute</h2>
        <p>You can sort data by an attribute value with the <code>attributeSortItem</code> property.</p>
        ...
        <p>
            When sorting insights with multiple attributes in different dimensions by measure,
            specify an <code>attributeSortItem</code> with <code>aggregation: &apos;sum&apos;</code> or
            <code>measureSortItem</code> with an <code>attributeLocator</code> property.
