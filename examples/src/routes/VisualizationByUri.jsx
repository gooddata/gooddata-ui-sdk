...
export const VisualizationByUri = () => (
    <div>
        ...
        <p>These are the examples of the generic Visualization component that uses URI to identify insights.</p>

        <hr className="separator" />

        <h2 id="column-chart">Column Chart</h2>
        <ExampleWithSource for={VisualizationColumnChartExample} source={VisualizationColumnChartByUriExampleSRC} />
