...
export class MultipleDomainsExample extends Component {
    ...
    setSdk2(e) {
        ...
        sdk2.user.login(formValues.sdk2Username, formValues.sdk2Password)
            .then(() => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h2>Second SDK:</h2>
                KPI: <Kpi
                    projectId={sdk2Config.projectId}
                    measure={sdk2Config.measureId}
                    sdk={sdk2}
                />
                ...
                <div className="gd-message warning contrast">
                    <div className="gd-message-text">
                        ...
                        <br /><br />
                        ie. <a href="https://stg3-webapp-mgmt-console.na.intgdc.com/#/management/cors">staging3</a> is configured for https://127.0.0.1:8999
                    </div>
                </div>
                ...
                <form action="?" method="get" onSubmit={this.setSdk2}>
                    <table>
                        <tbody>
                            <tr><td>Domain: </td><td><input type="text" name="domain" defaultValue="staging3.intgdc.com" /></td></tr>
                            <tr><td>Username: </td><td><input type="text" name="sdk2Username" /></td></tr>
                            <tr><td>Password: </td><td><input type="password" name="sdk2Password" /></td></tr>
                            <tr><td>KPI project id: </td><td><input type="text" name="projectId" defaultValue="kytra720hke4d84e8ozohoz7uycn53mi" /></td></tr>
                            <tr><td>KPI measure id: </td><td><input type="text" name="measureId" defaultValue="aa7ulGyKhIE5" /></td></tr>
                        </tbody>
                    </table>
                ...
                <p>
                    <strong>Example ids:</strong><br />
                    stg3 - projectid: kytra720hke4d84e8ozohoz7uycn53mi measureid: aa7ulGyKhIE5<br />
                    giraffes.intgdc.com - projectid: WalkMeDemo measureid: aaeFKXFYiCc0
                </p>
                <p>
                    <strong style={{ marginTop: '2em' }}>Local proxy with CORS</strong><br />
                    If you don&apos;t want to setup GDC webapp, you may use local proxy (grizzly) with <a href="https://github.com/gooddata/grunt-grizzly/pull/42">this configuration</a>.
                </p>
            </div>
        );
    }
